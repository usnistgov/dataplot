...
PURPOSE--CONTAIN SYNONYMS FOR RETRIES OF THE HELP FILE (LAST UPDATED 2024/07)
...
CALI                                    FIT
CALL     CLIP                           CLIPBOAR
CANDLEST PLOT BAR WIDT                  CANDLEST PLOT
CANTER                                  CANTER   NUMB
CAPTURE  BOX                            CAPTURE
...
DOT      MATR PROP PLOT                 DOT      MATR PLOT
...
FISHER   CLAS PLOT                      FISHER   DISC PLOT
FISHER   LINE CLAS PLOT                 FISHER   DISC PLOT
FISHER   LINE DISC PLOT                 FISHER   DISC PLOT
FISHER   DISC EIGE EPSI                 FISHER   DISC PLOT
FISHER   NUMB OF   DISC                 FISHER   DISC PLOT
FISHER   RAND TEST                      FISHER   TWO  SAMP RAND TEST
FITT                                    FIT
FITTING                                 FIT
FLIGNER  POLI                           FLIGNER  POLI TEST
FLIP                                    REVERSE
FLOATING BAR  CHAR                      DUMBBELL PLOT
FLOATING BAR  PLOT                      DUMBBELL PLOT
...
INDEX    GREA THAN OR   EQUA TO         INDEX    GREA THAN
INDEX    LAST MATC                      INDEX    FIRS MATC
INDEX    LAST NOT  MATC                 INDEX    FIRS MATC
INDEX    LESS THAN OR   EQUA TO         INDEX    GREA THAN
INDEX    LESS THAN                      INDEX    GREA THAN
...
JOCNKHEE TERP TEST                      JONCKHEE TERP
JPEG                                    GD
...
KENDALL  TAU  B    CONF INTE            KENDALL  TAU  B    CONF LIMI
KENDALL  TAU  C                         KENDALL  TAU
KENDALL  TAU  CONF INTE                 KENDALL  TAU  B    CONF LIMI
KENDALL  TAU  CONF LIMI                 KENDALL  TAU  B    CONF LIMI
...
K        MEDO                           CLUSTER
K        MEDO CLUS                      CLUSTER
K        NEAR NEIG CLAS PLOT            K        NEAR NEIG CLAS PLOT
K        NEAR NEIG DISC PLOT            K        NEAR NEIG CLAS PLOT
K        NEAR NEIG PLOT                 K        NEAR NEIG CLAS PLOT
KNN      CLAS PLOT                      K        NEAR NEIG CLAS PLOT
KNN      DISC PLOT                      K        NEAR NEIG CLAS PLOT
...
LATEX    CAPT GRAP                      LATEX
LATEX    CAPT                           CAPTURE  LATE
LATEX    COLO                           LATEX
LATEX    DRIV                           LATEX
LATEX    GRAP                           LATEX
LATEX    HARD FILL                      LATEX
LATEX    IMPO PDF                       CAPTURE  LATE
LATEX    LINE THIC                      LATEX
LATEX    OUTP                           CAPTURE  LATE
LATEX    RESI                           CAPTURE  LATE
LATEX    TYPE                           CAPTURE  LATE
LEADS    IN   COIN TOSS DIST            LCTPDF
LEADS    IN   COIN TOSS                 LCTPDF
LEAST    PROD FIT                       ORDINARY LEAS PROD FIT
LEAST    PROD REGR                      ORDINARY LEAS PROD FIT
LEAST    SQUA                           FIT
...
LINEARIT                                FIT
LINEAR   CLAS PLOT                      FISHER   DISC PLOT
LINEAR   DISC PLOT                      FISHER   DISC PLOT
...
NE                                      AGREE
NEAREST  NEIG CLAS K                    K        NEAR NEIG CLAS PLOT
NEAREST  NEIG CLAS PRIN COMP            K        NEAR NEIG CLAS PLOT
...
NUMBER   OF   COMM DIGI                 COMMON   DIGI
NUMBPC                                  MACHINE  CONS
NUMBPW                                  MACHINE  CONS
NUMCPW                                  MACHINE  CONS
...
N                                       WORKSPAC SWIT
OCLH     PLOT                           OPEN     CLOS LOW  HIGH PLOT
...
ONE      WAY  SUMM ANAL OF   VARI       ONE      WAY  ANOV
...
ORDINARY LEAS PROD REGR                 ORDINARY LEAS PROD FIT
...
PASSING  BABL REGR                      PASSING  BABL FIT
PAUSE    CLIP                           CLIPBOAR
...
QWIN     SYST                           SYSTEM
R        PATH                           RSCRIPT
RANGE    BAR  CHART                     DUMBBELL PLOT
RANGE    BAR  PLOT                      DUMBBELL PLOT
RANK3                                   RANK2
RANK4                                   RANK2
...
REPLICAT WEIG DEMI FIT                  DEMING   FIT
REPLICAT WEIG DEMI REGR                 DEMING   FIT
RESAMPLI                                BOOTSTRA
RESIDUAL                                FIT
...
RIDGELIN PLOT HEIG                      RIDGELIN PLOT
RIDGELIN PLOT TYPE                      RIDGELIN PLOT
RIEMANN  ZETA                           ZETA
...
SET      BROW                           WEB
SET      CAND PLOT BAR WIDT             CANDLEST PLOT
...
SET      FISH DISC EIGE EPSI            FISHER   DISC PLOT
SET      FISH NUMB OF   DISC            FISHER   DISC PLOT
...
SET      LATE CAPT GRAP                 LATEX
SET      LATE CAPT                      CAPTURE  LATE
SET      LATE COLO                      LATEX
SET      LATE DRIV                      LATEX
SET      LATE HARD FILL                 LATEX
SET      LATE IMPO GRAP                 CAPTURE  LATE
SET      LATE LINE THIC                 LATEX
SET      LATE RESI                      CAPTURE  LATE
SET      LATE TYPE                      CAPTURE  LATE
...
SET      NEAR NEIG CLAS K               K        NEAR NEIG CLAS PLOT
SET      NEAR NEIG CLAS PRIN COMP       K        NEAR NEIG CLAS PLOT
SET      NETS                           WEB
...
SET      RIDG PLOT HEIG                 RIDGELIN PLOT
SET      RIDG PLOT TYPE                 RIDGELIN PLOT
...
SET      VARI WIDT BAR  CHAR CONN       VARIABLE WIDT BAR  PLOT
SET      VARI WIDT BAR  PLOT CONN       VARIABLE WIDT BAR  PLOT
...
SPAN     CHAR                           DUMBBELL PLOT
SPAN     PLOT                           DUMBBELL PLOT
...
VARIABLE WIDT BAR  CHAR                 VARIABLE WIDT BAR  PLOT
VARIABLE WIDT BAR  CHAR CONN            VARIABLE WIDT BAR  PLOT
VARIABLE WIDT BAR  PLOT CONN            VARIABLE WIDT BAR  PLOT
...
WEIGHTED DEMI FIT                       DEMING   FIT
WEIGHTED DEMI REGR                      DEMING   FIT
WEIGHTED REPL DEMI FIT                  DEMING   FIT
WEIGHTED REPL DEMI REGR                 DEMING   FIT
WHB                                     WEB
WHILE                                   LOOP
