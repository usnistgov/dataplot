...
BULLET PLOT                 GR-CO Generate a bullet plot

C CHART                     GR-CO Generate a C control chart
CANDLESTICK PLOT            GR-CO Generate a candlestick plot
...
DOT MATRIX PLOT             GR-CO Generate a dot matrix plot
DOT MATRIX PROPORTION PLOT  GR-CO Generate a dot matrix proportion plot
DUANE PLOT                  GR-CO Generate a Duane plot
DUMBBELL PLOT               GR-CO Generate a Dumbbell plot
...
FISHER DISC PLOT            GR-CO Generate a Fisher discrimination plot
...
JONCKHEERE TERPSTRA TEST    AN-CO Perform Jonckheere-Terpstra one factor test

K CONSISTENCY PLOT          GR-CO Generate a K consistency plot
KERNEL DENSITY PLOT         GR-CO Generate a kernel density plot
K NEAREST NEIGHBOR CLAS PLOTGR-CO Generate a K nearest neighbor classification plot
K NEAREST NEIGHBOR DISC PLOTGR-CO Generate a K nearest neighbor classification plot
K NEAREST NEIGHBOR PLOT     GR-CO Generate a K nearest neighbor classification plot
KNN PLOT                    GR-CO Generate a K nearest neighbor classification plot
KNN CLASSIFICATION PLOT     GR-CO Generate a K nearest neighbor classification plot
KNN DISCRIMINATION PLOT     GR-CO Generate a K nearest neighbor classification plot
...
OPEN CLOSE LOW HIGH PLOT    GR-CO Generate an open close low high plot
...
RIDGELINE PLOT              GR-CO Generate a ridgeline plot
...
VARIABLE WIDTH BAR PLOT     GR-CO Generate a variable width bar plot
...
WAFFLE PLOT                 GR-CO Generate a dot matrix proportion plot
WATERFALL CHART             GR-CO Generate a Waterfall chart
...
DEMING FIT                  AN-CO Perform a Deming regression
DEMING REGRESSION           AN-CO Perform a Deming regression
...
REPLICATED WEIG DEMING FIT  AN-CO Perform a Deming regression
REPLICATED WEIG DEMING REGR AN-CO Perform a Deming regression
...
WEIGHTED DEMING FIT         AN-CO Perform a Deming regression
WEIGHTED DEMING REGRESSION  AN-CO Perform a Deming regression
WEIGHTED REPL DEMING FIT    AN-CO Perform a Deming regression
WEIGHTED REPL DEMING REGR   AN-CO Perform a Deming regression
...
LATEX                       GD-CO Set device 1/2 to LATEX
...
CONTINUE LOOP               SU-CO Go to next iteration of a LOOP
...
GROUPED CORRELATION         SC-LE Compute the correlation for grouped data
GROUPED PERCENTILE          SC-LE Compute a percentile for grouped data
GROUPED QUANTILE            SC-LE Compute a quantile for grouped data
...
NUMBER TO CURRENCY          SC-LE Convert a number to a string in currency format
NUMBER TO STRING            SC-LE Convert a number to a string in currency format

ORDER STATISTIC MEANS       SC-LE Generate order statistic means
ORDER STATISTIC MEDIANS     SC-LE Generate order statistic medians
ORDER STATISTIC STAND DEVI  SC-LE Generate order statistic standard deviations
ORDER STATISTIC             SC-LE Generate order statistics
PARETO RANDOM NUMBERS       SC-LE Generate Pareto random numbers
PATTERN                     SC-LE Generate a patterned sequence within a var
PERCENT ACCEPTABLE          SC-LE Compute the percentage of acceptables
PERCENT DEFECTIVE           SC-LE Compute the percentage of defectives
...
VARIABLE TO MATRIX          SC-LE Convert a variable to a matrix
...
LATEX CAPTION               SC-SE Specify caption for CAPTURE LATEX
LATEX COLOR                 SC-SE Specify color for LaTeX device
LATEX CAPTURE GRAPHICS      SC-SE Specify how CAPTURE LATEX imports graphs
LATEX DRIVER                SC-SE Specify whether epic/eepic or TikZ used for LATEX
LATEX FONT FAMILY           SC-SE Specify font family for LATEX (TikZ)
LATEX FONT STYLE            SC-SE Specify font style for LATEX (TikZ)
LATEX HARDWARE FILL         SC-SE Specify how region fills generated for LATEX
LATEX IMPORT PDF            SC-SE Specify how PDF files are incorporated with CAPTURE LATEX
LATEX LINE THICKNESS        SC-SE Specify line thickness for LATEX
LATEX TIKZ HEIGHT           SC-SE Specify plot height for LATEX (TikZ)
LATEX TIKZ WIDTH            SC-SE Specify plot width for LATEX (TikZ)
LATEX LINE TYPE             SC-SE Specify whether CAPTURE LATEX will import Postscript or PDF
