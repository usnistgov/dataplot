...
!              FOR ROMAN TRIPLEX ITALIC LOWER CASE (PART 1).
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3151--LOWER CASE A
!
...
!
      ...
      DATA NUMCOO(   1)/  44/
!
!     DEFINE CHARACTER   3152--LOWER CASE B
!
...
!
      ...
      DATA NUMCOO(   2)/  45/
!
!     DEFINE CHARACTER   3153--LOWER CASE C
!
...
!
      ...
      DATA NUMCOO(   3)/  31/
!
!     DEFINE CHARACTER   3154--LOWER CASE D
!
...
!
      ...
      DATA NUMCOO(   4)/  50/
!
!     DEFINE CHARACTER   3155--LOWER CASE E
!
...
!
      ...
      DATA NUMCOO(   5)/  30/
!
!     DEFINE CHARACTER   3156--LOWER CASE F
!
...
!
      ...
      DATA NUMCOO(   6)/  41/
!
!     DEFINE CHARACTER   3157--LOWER CASE G
!
...
!
      RETURN
      END SUBROUTINE DRTIL1
      SUBROUTINE DRTIL2(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC LOWER CASE (PART 2).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3158--LOWER CASE H
!
...
!
      ...
      DATA NUMCOO(   8)/  33/
!
!     DEFINE CHARACTER   3159--LOWER CASE I
!
...
!
      ...
      DATA NUMCOO(   9)/  29/
!
!     DEFINE CHARACTER   3160--LOWER CASE J
!
...
!
      ...
      DATA NUMCOO(  10)/  39/
!
!     DEFINE CHARACTER   3161--LOWER CASE K
!
...
!
      ...
      DATA NUMCOO(  11)/  40/
!
!     DEFINE CHARACTER   3162--LOWER CASE L
!
...
!
      ...
      DATA NUMCOO(  12)/  21/
!
!     DEFINE CHARACTER   3163--LOWER CASE M
!
...
!
      ...
      DATA NUMCOO(  13)/  52/
!
!     DEFINE CHARACTER   3164--LOWER CASE N
!
...
!
      ...
      DATA NUMCOO(  14)/  36/
!
!     DEFINE CHARACTER   3165--LOWER CASE O
!
...
!
      RETURN
      END SUBROUTINE DRTIL2
      SUBROUTINE DRTIL3(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC LOWER CASE (PART 3).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3166--LOWER CASE P
!
...
!
      ...
      DATA NUMCOO(  16)/  55/
!
!     DEFINE CHARACTER   3167--LOWER CASE Q
!
...
!
      ...
      DATA NUMCOO(  17)/  46/
!
!     DEFINE CHARACTER   3168--LOWER CASE R
!
...
!
      ...
      DATA NUMCOO(  18)/  26/
!
!     DEFINE CHARACTER   3169--LOWER CASE S
!
...
!
      ...
      DATA NUMCOO(  19)/  42/
!
!     DEFINE CHARACTER   3170--LOWER CASE T
!
...
!
      ...
      DATA NUMCOO(  20)/  19/
!
!     DEFINE CHARACTER   3171--LOWER CASE U
!
...
!
      ...
      DATA NUMCOO(  21)/  36/
!
!     DEFINE CHARACTER   3172--LOWER CASE V
!
...
!
      ...
      DATA NUMCOO(  22)/  26/
!
!     DEFINE CHARACTER   3173--LOWER CASE W
!
...
!
      RETURN
      END SUBROUTINE DRTIL3
      SUBROUTINE DRTIL4(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC LOWER CASE (PART 4).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3174--LOWER CASE X
!
...
!
      ...
      DATA NUMCOO(  24)/  46/
!
!     DEFINE CHARACTER   3175--LOWER CASE Y
!
...
!
      ...
      DATA NUMCOO(  25)/  43/
!
!     DEFINE CHARACTER   3176--LOWER CASE Z
!
...
!
      RETURN
      END SUBROUTINE DRTIL4
      SUBROUTINE DRTIN1(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC NUMERIC (PART 1).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!
      RETURN
      END SUBROUTINE DRTIN1
      SUBROUTINE DRTIN2(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC NUMERIC (PART 2).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!
      RETURN
      END SUBROUTINE DRTIN2
      SUBROUTINE DRTIU1(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC UPPER CASE (PART 1).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER  3501--UPPER CASE A
!
      DATA IOPERA(   1),IX(   1),IY(   1)/'MOVE',   3,  12/
...
!
      ...
      DATA NUMCOO(   1)/  26/
!
!     DEFINE CHARACTER  3502--UPPER CASE B
!
...
!
      ...
      DATA NUMCOO(   2)/  61/
!
!     DEFINE CHARACTER  3503--UPPER CASE C
!
...
!
      ...
      DATA NUMCOO(   3)/  38/
!
!     DEFINE CHARACTER  3504--UPPER CASE D
!
...
!
      ...
      DATA NUMCOO(   4)/  49/
!
!     DEFINE CHARACTER  3505--UPPER CASE E
!
...
!
      ...
      DATA NUMCOO(   5)/  55/
!
!     DEFINE CHARACTER  3506--UPPER CASE F
!
...
!
      RETURN
      END SUBROUTINE DRTIU1
      SUBROUTINE DRTIU2(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC UPPER CASE (PART 2).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER  3507--UPPER CASE G
!
...
!
      ...
      DATA NUMCOO(   7)/  55/
!
!     DEFINE CHARACTER  3508--UPPER CASE H
!
...
!
      ...
      DATA NUMCOO(   8)/  54/
!
!     DEFINE CHARACTER  3509--UPPER CASE I
!
...
!
      ...
      DATA NUMCOO(   9)/  26/
!
!     DEFINE CHARACTER  3510--UPPER CASE J
!
...
!
      ...
      DATA NUMCOO(  10)/  38/
!
!     DEFINE CHARACTER  3511--UPPER CASE K
!
...
!
      ...
      DATA NUMCOO(  11)/  48/
!
!     DEFINE CHARACTER  3512--UPPER CASE L
!
...
!
      ...
      DATA NUMCOO(  12)/  33/
!
!     DEFINE CHARACTER  3513--UPPER CASE M
!
...
!
      RETURN
      END SUBROUTINE DRTIU2
      SUBROUTINE DRTIU3(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC UPPER CASE (PART 3).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER  3514--UPPER CASE N
!
      DATA IOPERA(   1),IX(   1),IY(   1)/'MOVE',  -3,  12/
      DATA IOPERA(   2),IX(   2),IY(   2)/'DRAW',  -9,  -8/
...
!
      ...
      DATA NUMCOO(  14)/  29/
!
!     DEFINE CHARACTER  3515--UPPER CASE O
!
...
!
      ...
      DATA NUMCOO(  15)/  51/
!
!     DEFINE CHARACTER  3516--UPPER CASE P
!
...
!
      ...
      DATA NUMCOO(  16)/  45/
!
!     DEFINE CHARACTER  3517--UPPER CASE Q
!
...
!
      ...
      DATA NUMCOO(  17)/  70/
!
!     DEFINE CHARACTER  3518--UPPER CASE R
!
...
!
      ...
      DATA NUMCOO(  18)/  60/
!
!     DEFINE CHARACTER  3519--UPPER CASE S
!
...
!
      RETURN
      END SUBROUTINE DRTIU3
      SUBROUTINE DRTIU4(ICHARN,IOP,X,Y,NUMCO,IXMINS,IXMAXS,IXDELS,   &
      IBUGD2,IFOUND,IERROR)
!
!     PURPOSE--DEFINE AND SET THE HERSHEY CHARACTER SET COORDINATES
!              FOR ROMAN TRIPLEX ITALIC UPPER CASE (PART 4).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 CENTER FOR APPLIED MATHEMATICS
!                 NATIONAL BUREAU OF STANDARDS
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER  3520--UPPER CASE T
!
      DATA IOPERA(   1),IX(   1),IY(   1)/'MOVE',   2,  12/
...
!
      ...
      DATA NUMCOO(  20)/  36/
!
!     DEFINE CHARACTER  3521--UPPER CASE U
!
...
!
      ...
      DATA NUMCOO(  21)/  37/
!
!     DEFINE CHARACTER  3522--UPPER CASE V
!
      DATA IOPERA(  74),IX(  74),IY(  74)/'MOVE',  -4,  12/
...
!
      ...
      DATA NUMCOO(  22)/  24/
!
!     DEFINE CHARACTER  3523--UPPER CASE W
!
...
!
      ...
      DATA NUMCOO(  23)/  40/
!
!     DEFINE CHARACTER  3524--UPPER CASE X
!
...
!
      ...
      DATA NUMCOO(  24)/  36/
!
!     DEFINE CHARACTER  3525--UPPER CASE Y
!
...
!
      ...
      DATA NUMCOO(  25)/  35/
!
!     DEFINE CHARACTER  3526--UPPER CASE Z
!
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3101--LOWER CASE A
!
...
!
      ...
      DATA NUMCOO(   1)/  48/
!
!     DEFINE CHARACTER   3102--LOWER CASE B
!
...
!
      ...
      DATA NUMCOO(   2)/  39/
!
!     DEFINE CHARACTER   3103--LOWER CASE C
!
...
!
      ...
      DATA NUMCOO(   3)/  31/
!
!     DEFINE CHARACTER   3104--LOWER CASE D
!
...
!
      ...
      DATA NUMCOO(   4)/  42/
!
!     DEFINE CHARACTER   3105--LOWER CASE E
!
...
!
      ...
      DATA NUMCOO(   5)/  36/
!
!     DEFINE CHARACTER   3106--LOWER CASE F
!
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3107--LOWER CASE G
!
...
!
      ...
      DATA NUMCOO(   7)/  79/
!
!     DEFINE CHARACTER   3108--LOWER CASE H
!
...
!
      ...
      DATA NUMCOO(   8)/  47/
!
!     DEFINE CHARACTER   3109--LOWER CASE I
!
...
!
      ...
      DATA NUMCOO(   9)/  30/
!
!     DEFINE CHARACTER   3110--LOWER CASE J
!
...
!
      ...
      DATA NUMCOO(  10)/  33/
!
!     DEFINE CHARACTER   3111--LOWER CASE K
!
...
!
      ...
      DATA NUMCOO(  11)/  41/
!
!     DEFINE CHARACTER   3112--LOWER CASE L
!
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3113--LOWER CASE M
!
...
!
      ...
      DATA NUMCOO(  13)/  73/
!
!     DEFINE CHARACTER   3114--LOWER CASE N
!
...
!
      ...
      DATA NUMCOO(  14)/  47/
!
!     DEFINE CHARACTER   3115--LOWER CASE O
!
...
!
      ...
      DATA NUMCOO(  15)/  41/
!
!     DEFINE CHARACTER   3116--LOWER CASE P
!
...
!
      ...
      DATA NUMCOO(  16)/  47/
!
!     DEFINE CHARACTER   3117--LOWER CASE Q
!
...
!
      ...
      DATA NUMCOO(  17)/  44/
!
!     DEFINE CHARACTER   3118--LOWER CASE R
!
...
!-----DATA STATEMENTS-------------------------------------------------
!
!     DEFINE CHARACTER   3119--LOWER CASE S
!
...
!
      ...
      DATA NUMCOO(  19)/  38/
!
!     DEFINE CHARACTER   3120--LOWER CASE T
!
...
!
      ...
      DATA NUMCOO(  20)/  18/
!
!     DEFINE CHARACTER   3121--LOWER CASE U
!
...
!
      ...
      DATA NUMCOO(  21)/  33/
!
!     DEFINE CHARACTER   3122--LOWER CASE V
!
...
!
      ...
      DATA NUMCOO(  22)/  21/
!
!     DEFINE CHARACTER   3123--LOWER CASE W
!
...
!
      ...
      DATA NUMCOO(  23)/  31/
!
!     DEFINE CHARACTER   3124--LOWER CASE X
!
...
!
      ...
      DATA NUMCOO(  24)/  32/
!
!     DEFINE CHARACTER   3125--LOWER CASE Y
!
...
!
      ...
      DATA NUMCOO(  25)/  30/
!
!     DEFINE CHARACTER   3126--LOWER CASE Z
!
...
!
      ...
      DATA NUMCOO(   3)/  28/
!
!     DEFINE CHARACTER   3213--; (SEMICOLON)
!
...
!
      ...
      DATA NUMCOO(   4)/  34/
!
!     DEFINE CHARACTER   3214--! (EXCLAMATION POINT)
!
...
!
      ...
      DATA NUMCOO(   5)/  28/
!
!     DEFINE CHARACTER   3215--? (QUESTION MARK)
!
...
!
      ...
      DATA NUMCOO(   6)/  46/
!
!     DEFINE CHARACTER   3218--& (AMPERSAND)
!
...
!
      ...
      DATA NUMCOO(   7)/  66/
!
!     DEFINE CHARACTER   3219--$ (DOLLAR SIGN)
!
...
!
      ...
      DATA NUMCOO(   9)/   6/
!
!     DEFINE CHARACTER   3221--( (LEFT PARENTHESES)
!
...
!
      ...
      DATA NUMCOO(  10)/  24/
!
!     DEFINE CHARACTER   3222--) (RIGHT PARENTHESES)
!
...
!
      ...
      DATA NUMCOO(  11)/  24/
!
!     DEFINE CHARACTER   3223--* (ASTERISK)
!
...
!
      ...
      DATA NUMCOO(  12)/  30/
!
!     DEFINE CHARACTER   3224--- (HYPHEN OR MINUS SIGN)
!
...
!
      ...
      DATA NUMCOO(  13)/   6/
!
!     DEFINE CHARACTER   3225--+ (PLUS SIGN)
!
...
!
      ...
      DATA NUMCOO(  14)/  12/
!
!     DEFINE CHARACTER   3226--= (EQUAL SIGN)
!
...
!
      ...
      DATA NUMCOO(  15)/  12/
!
!     DEFINE CHARACTER   3227--' (SINGLE QUOTE)
!
...
!
      ...
      DATA NUMCOO(  16)/   8/
!
!     DEFINE CHARACTER   3228--  (DOUBLE QUOTE)
!
...
!
      ...
      DATA NUMCOO(  18)/  27/
!
!     DEFINE CHARACTER   3247--  (NO   SPACE BLANK)
!
...
!
      ...
      DATA NUMCOO(  19)/   2/
!
!     DEFINE CHARACTER   3248--  (HALF SPACE BLANK)
!
...
!
      ...
      DATA NUMCOO(  20)/   2/
!
!     DEFINE CHARACTER   3249--  (FULL SPACE BLANK)
!
...
!
      ...
      DATA NUMCOO(  21)/   2/
!
!     DEFINE CHARACTER   3216--  (LEFT  APOSTRAPHE)
!
...
!
      ...
      DATA NUMCOO(  22)/  20/
!
!     DEFINE CHARACTER   3217--  (RIGHT APOSTRAPHE)
!
