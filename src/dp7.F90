...
!
      ...
      DATA NUMCOO(   3)/  18/
!
!     DEFINE CHARACTER  2223--LBRACKET (LEFT  BRACKET)
!
...
!
      ...
      DATA NUMCOO(   4)/   8/
!
!     DEFINE CHARACTER  2224--RBRACKET (RIGHT BRACKET)
!
...
!
      ...
      DATA NUMCOO(   5)/   8/
!
!     DEFINE CHARACTER  2225--LBRACE (LEFT  BRACE)
!
...
!
      ...
      DATA NUMCOO(   6)/  37/
!
!     DEFINE CHARACTER  2226--RBRACE (RIGHT BRACE)
!
...
!
      ...
      DATA NUMCOO(   7)/  37/
!
!     DEFINE CHARACTER  2227--LELBOW (LEFT  ELBOW)
!
...
!
      ...
      DATA NUMCOO(   8)/   3/
!
!     DEFINE CHARACTER  2228--RELBOW (RIGHT ELBOW)
!
...
!
      ...
      DATA NUMCOO(   9)/   3/
!
!     DEFINE CHARACTER  2229--VBAR (VERTICAL BAR)
!
...
!
      ...
      DATA NUMCOO(  10)/   2/
!
!     DEFINE CHARACTER  2230--DVBAR (DOUBLE VERTICAL BAR)
!
...
!
      ...
      DATA NUMCOO(  11)/   4/
!
!     DEFINE CHARACTER  2231--- (MINUS SIGN)
!
...
!
      ...
      DATA NUMCOO(  13)/   4/
!
!     DEFINE CHARACTER  2233--+- (PLUS OR MINUS)
!
...
!
      ...
      DATA NUMCOO(  14)/   6/
!
!     DEFINE CHARACTER  2234---+ (MINUS OR PLUS)
!
...
!
      ...
      DATA NUMCOO(  15)/   6/
!
!     DEFINE CHARACTER  2235--TIMES (TIMES SIGN)
!
...
!
      ...
      DATA NUMCOO(  16)/   4/
!
!     DEFINE CHARACTER  2236--DOTP (DOT PRODUCT SIGN)
!
...
!
      ...
      DATA NUMCOO(  17)/   5/
!
!     DEFINE CHARACTER  2237--DIVISION (DIVISION SIGN)
!
...
!
      ...
      DATA NUMCOO(  19)/   4/
!
!     DEFINE CHARACTER  2239--NOTEQ (NOT EQUAL SIGN)
!
...
!
      ...
      DATA NUMCOO(  20)/   6/
!
!     DEFINE CHARACTER  2240--EQUIVALE (EQUIVALENCE SIGN)
!
...
!
      ...
      DATA NUMCOO(  21)/   6/
!
!     DEFINE CHARACTER  2241--< (LESS THAN SIGN)
!
...
!
      ...
      DATA NUMCOO(  22)/   3/
!
!     DEFINE CHARACTER  2242--> (GREATER THAN SIGN)
!
...
!
      ...
      DATA NUMCOO(  23)/   3/
!
!     DEFINE CHARACTER  2243--LTEQ (LESS THAN OR EQUAL TO SIGN)
!
...
!
      ...
      DATA NUMCOO(  24)/   7/
!
!     DEFINE CHARACTER  2244--GTEQ (GREATER THAN OR EQUAL TO SIGN)
!
...
!
      ...
      DATA NUMCOO(  25)/   7/
!
!     DEFINE CHARACTER  2245--VARIES (VARIES SIGN)
!
...
!
      ...
      DATA NUMCOO(  26)/  20/
!
!     DEFINE CHARACTER  2246--APPROX (APPROXIMATION SIGN)
!
...
!
      ...
      DATA NUMCOO(  27)/  22/
!
!     DEFINE CHARACTER  2247--CARAT (CARAT)
!
...
!
      ...
      DATA NUMCOO(  28)/   6/
!
!     DEFINE CHARACTER  2248--PRIME (PRIME = RIGHT ACCENT)
!
...
!
      ...
      DATA NUMCOO(  29)/   5/
!
!     DEFINE CHARACTER  2249--LACCENT (LEFT ACCENT)
!
...
!
      ...
      DATA NUMCOO(  30)/   5/
!
!     DEFINE CHARACTER  2250--BREVE (BREVE)
!
...
!
      ...
      DATA NUMCOO(  31)/  16/
!
!     DEFINE CHARACTER  2251--RQUOTE (RIGHT QUOTE)
!
...
!               *********************************************
!               **  STEP 3--                               **
!               **  ADJUST THE COORDINATES IF A CIRCLE.    **
!               **  IF THE CHARACTER IS A CIRCLE           **
!               **  THEN SCALE THE FIGURE DOWN FROM        **
!               **  -17 TO 17  TO THE MORE USUAL -7 TO 7.  **
!               **  THE ORIGINAL CIRCLE WAS FROM -17 TO 17 **
!               **  RATHER THAN -7 TO 7 IN                 **
!               **  ORDER TO INCREASE THE RESOLUTION       **
!               **  AND GIVE A 32 POINT CIRCLE RATHER      **
!               **  THAN A 16 POINT CIRCLE.                **
!               *********************************************
!
      IF(ICHARN.EQ.102)GO TO 1210
      GO TO 1290
!
 1210 CONTINUE
      AFACTO=7.0/17.0
...
!
 9000 CONTINUE
      IF(IBUGG4.EQ.'OFF'.AND.ISUBG4.NE.'MATH')GO TO 9090
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,9011)
...
!     DEFINE CHARACTER  2252--LQUOTE (LEFT QUOTE)
!
...
!
      ...
      DATA NUMCOO(  33)/   7/
!
!     DEFINE CHARACTER  2253--NASPIRAT (NORMAL ASPIRATE)
!
...
!
      ...
      DATA NUMCOO(  34)/   7/
!
!     DEFINE CHARACTER  2254--IASPIRAT (INVERTED ASPIRATE)
!
...
!
      ...
      DATA NUMCOO(  35)/   7/
!
!     DEFINE CHARACTER  2255--RADICAL (RADICAL)
!
...
!
      ...
      DATA NUMCOO(  36)/   7/
!
!     DEFINE CHARACTER  2256--SUBSET (SUBSET SYMBOL)
!
...
!
      ...
      DATA NUMCOO(  37)/  12/
!
!     DEFINE CHARACTER  2257--UNION (UNION SYMBOL)
!
...
!
      ...
      DATA NUMCOO(  38)/  12/
!
!     DEFINE CHARACTER  2258--SUPERSET (SUPERSET SYMBOL)
!
...
!
      ...
      DATA NUMCOO(  39)/  12/
!
!     DEFINE CHARACTER  2259--INTERSEC (INTERSECTION SYMBOL)
!
...
!
      ...
      DATA NUMCOO(  40)/  12/
!
!     DEFINE CHARACTER  2260--ELEMENT (ELEMENT SYMBOL)
!
...
!
      ...
      DATA NUMCOO(  41)/  14/
!
!     DEFINE CHARACTER  2261--RARROW (RIGHT ARROW)
!
...
!
      ...
      DATA NUMCOO(  42)/   8/
!
!     DEFINE CHARACTER  2262--UARROW (UP ARROW)
!
...
!
      ...
      DATA NUMCOO(  43)/   8/
!
!     DEFINE CHARACTER  2263--LARROW (LEFT ARROW)
!
...
!
      ...
      DATA NUMCOO(  44)/   8/
!
!     DEFINE CHARACTER  2264--DARROW (DOWN ARROW)
!
...
!
      ...
      DATA NUMCOO(  45)/   8/
!
!     DEFINE CHARACTER  2265--PARTIAL (PARTIAL DERIVATIVE = NABLA)
!
...
!
      ...
      DATA NUMCOO(  46)/  41/
!
!     DEFINE CHARACTER  2266--DEL (DELTA = VECTOR OPERATOR)
!
...
!
      ...
      DATA NUMCOO(  47)/  10/
!
!     DEFINE CHARACTER  2267--LRADICAL (LONGER RADICAL)
!
...
!
      ...
      DATA NUMCOO(  48)/   7/
!
!     DEFINE CHARACTER  2268--INTEGRAL (INTEGRAL)
!
...
!
      ...
      DATA NUMCOO(  49)/  30/
!
!     DEFINE CHARACTER  2269--CINTEGRA (CIRCULAR INTEGRAL)
!
...
!
      ...
      DATA NUMCOO(  50)/  47/
!
!     DEFINE CHARACTER  2270--INFINITY (INFINITY SIGN)
!
...
!     DEFINE CHARACTER  2271--% (PERCENT SIGN)
!
...
!
      ...
      DATA NUMCOO(  55)/  38/
!
!     DEFINE CHARACTER  2275--# (NUMBER SIGN)
!
...
!
      ...
      DATA NUMCOO(  56)/   8/
!
!     DEFINE CHARACTER  2276--PARAGRAP (PARAGRAPH SYMBOL)
!
...
!
      ...
      DATA NUMCOO(  57)/  42/
!
!     DEFINE CHARACTER  2277--DAGGER (DAGGER)
!
...
!
      ...
      DATA NUMCOO(  58)/  24/
!
!     DEFINE CHARACTER  2278--DDAGGER (DOUBLE DAGGER)
!
...
!
      ...
      DATA NUMCOO(  59)/  45/
!
!     DEFINE CHARACTER  2279--THEREEXI (THERE EXISTS SIGN)
!
...
!     UPDATED         --MARCH     1987.
!     UPDATED         --APRIL     1987.
!     UPDATED         --AUGUST    1992.  ADD ARROW CHARACTER.
!
!-----CHARACTER STATEMENTS FOR NON-COMMON VARIABLES-------------------
!
      CHARACTER*4 IOP
...
!
!-----DATA STATEMENTS-------------------------------------------------
!     DEFINE CHARACTER  2401--PRODUCT (PRODUCT SIGN)
!
...
!
      ...
      DATA NUMCOO(  61)/  14/
!
!     DEFINE CHARACTER  2402--SUMMATION (SUMMATION SIGN)
!
...
!
      ...
      DATA NUMCOO(  62)/  17/
!
!     DEFINE CHARACTER  2740--THEREEXI (THERE EXISTS SIGN)
!
...
!
      ...
      DATA NUMCOO(  63)/  15/
!
!     DEFINE CHARACTER  XX--LVBAR (LONGER VERTICAL BAR)
!
...
!
      ...
      DATA NUMCOO(  64)/   2/
!
!     DEFINE CHARACTER  2800--HBAR (HORIZONTAL BAR)
!
...
!
      ...
      DATA NUMCOO(  65)/   2/
!
!     DEFINE CHARACTER  2796--LHBAR (LONGER HORIZONTAL BAR)
!
...
!
      ...
      DATA NUMCOO(  66)/   2/
!
!     DEFINE CHARACTER  XXX--CENTERED POINT
!
...
!
      ...
      DATA NUMCOO(107)/6/
!
!     DEFINE CHARACTER  XXX--REVERSE TRIANGLE
!
...
!
      ...
      DATA NUMCOO(108)/4/
!
!     DEFINE CHARACTER  XX--VERTICAL BAR
!
...
!
      ...
      DATA NUMCOO(109)/2/
!
!     DEFINE CHARACTER  XX--HORIZONTAL BAR
!
...
!
      ...
      DATA NUMCOO(110)/2/
!
!     DEFINE CHARACTER  2262--UP ARROW
!
...
!
      ...
      DATA NUMCOO(111)/8/
!
!     DEFINE CHARACTER  2264--DOWN ARROW
!
...
!
      ...
      DATA NUMCOO(112)/8/
!
!     DEFINE CHARACTER  2263--LEFT ARROW
!
...
!
      ...
      DATA NUMCOO(113)/8/
!
!     DEFINE CHARACTER  2261--RIGHT ARROW
!
...
!
      ...
      DATA NUMCOO(114)/8/
!
!     DEFINE CHARACTER  804--BACK SLASH
!
...
!
      ...
      DATA NUMCOO(115)/2/
!
!     DEFINE CHARACTER  XX--UNDERSCORE
!
...
!
      ...
      DATA NUMCOO(118)/6/
!
!     AUGUST 1992.  ADD ARROW.  USE TRIANGLE COORDINATES FOR
!     NOW, MAY MODIFY LATER AS NEEDED (MODIFY SO THAT ARROW
!     COMES TO A POINT AT 0,0 SO ARROW HEAD IS AT CENTER POINT)
!     DEFINE CHARACTER  XXX--ARROW
!
...
!
      RETURN
      END SUBROUTINE DMATH4
      SUBROUTINE DNBRAN(N,ALPHA,BETA,ALAMB1,ALAMB2,ISEED,X)
!
!     PURPOSE--THIS SUBROUTINE GENERATES A RANDOM SAMPLE OF SIZE N
!              FROM THE DOUBLY NON-CENTRAL BETA DISTRIBUTION WITH SHAPE
!              PARAMETERS ALPHA AND BETA AND NON-CENTRALITY
...
!                     --ALAMB1 = THE SINGLE PRECISION VALUE OF THE
!                                FIRST NON-CENTRALITY PARAMETER.
!                     --ALAMB2 = THE SINGLE PRECISION VALUE OF THE
...
!             FROM THE DOUBLY NON-CENTRAL BETA DISTRIBUTION
!             WITH SHAPE PARAMETER VALUES = ALPHA, BETA, ALAMB1, AND
!             ALAMB2.
!     PRINTING--NONE UNLESS AN INPUT ARGUMENT ERROR CONDITION EXISTS.
!     RESTRICTIONS--THERE IS NO RESTRICTION ON THE MAXIMUM VALUE
!                   OF N FOR THIS SUBROUTINE.
!                 --ALPHA AND BETA  SHOULD BE POSITIVE.
!                 --ALAMB1 AND ALAMB2 SHOULD BE NON-NEGATIVE.
!     OTHER DATAPAC   SUBROUTINES NEEDED--NCCRAN, CHSRAN.
!     FORTRAN LIBRARY SUBROUTINES NEEDED--NONE.
!     MODE OF INTERNAL OPERATIONS--SINGLE PRECISION.
!     LANGUAGE--ANSI FORTRAN (1977)
!     REFERENCES--JOHNSON, KOTZ, AND BALAKRISHNAN, "CONTINUOUS
!                 UNIVARIATE DISTRIBUTIONS VOLUME 2", SECOND EDITION,
!                 1994, PAGES 502-503.
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
...
!
    ...
    5 FORMAT('***** ERROR--THE REQUESTED NUMBER OF DOUBLY NON-CENTRAL',   &
      ' BETA RANDOM NUMBERS IS NON-POSITIVE.')
   ...
   16 FORMAT('***** ERROR--THE SHAPE PARAMETER ALPHA FOR THE ',   &
      'DOUBLY NON-CENTRAL BETA RANDOM NUMBERS IS NON-POSITIVE.')
      IF(BETA.LE.0.0)THEN
        WRITE(ICOUT,26)
        CALL DPWRST('XXX','BUG ')
        WRITE(ICOUT,46)BETA
...
!
!     USE THE CENTRAL AND NON-CENTRAL CHI-SQUARE RANDOM NUMBER
!     ROUTINE TO GENERATE NON-CENTRAL BETA RANDOM NUMBERS.
!
!     NCB = NCCHISQ(NU1,LAMBDA)/(NCCHISQ(NU1,LAMBDA)+NCCHISQUARE(NU2))
!
      ANU1=ALPHA
      ANU2=BETA
      NTEMP=1
...
!
 9000 CONTINUE
      RETURN
      END SUBROUTINE DNBRAN
      SUBROUTINE DNFCDF(X,DF1,DF2,ALAMB1,ALAMB2,CDF)
!
!     PURPOSE--THIS SUBROUTINE COMPUTES THE CUMULATIVE DISTRIBUTION
!              FUNCTION VALUE FOR THE DOUBLY NON-CENTRAL F DISTRIBUTION
!              WITH REAL DEGREES OF FREEDOM
!              PARAMETERS = NU1 AND NU2.
!              THIS DISTRIBUTION IS DEFINED FOR ALL NON-NEGATIVE X.
!---------------------------------------------------------------------
!   CDFDNF   WRITTEN BY CHARLES P. REEVE, STATISTICAL ENGINEERING
!            DIVISION, NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY, GAITHERSBURG,
!            MARYLAND  20899
!
!   FOR: COMPUTING THE CUMULATIVE DISTRIBUTION FUNCTION OF THE DOUBLY
!        NONCENTRAL F DISTRIBUTION TO A SPECIFIED ACCURACY (TRUNCATION
!        ERROR IN THE INFINITE SERIES REPRESENTATION GIVEN BY EQUATION
!        2.2 IN REFERENCE 1 BELOW).  THE BETA C.D.F. ROUTINE IS CALLED
!        AT MOST TWO TIMES.  FURTHER VALUES OF THE BETA C.D.F. ARE
!        OBTAINED FROM RECURRENCE RELATIONS GIVEN IN REFERENCE 2.
!        REFERENCE 3 GIVES A DETAILED DESCRIPTION OF THE ALGORITHM
!        HEREIN.
!
!        THIS PROGRAM MAY ALSO BE EFFICIENTLY USED TO COMPUTE THE
!        CUMULATIVE DISTRIBUTION FUNCTIONS OF THE SINGLY NONCENTRAL
!        AND CENTRAL F DISTRIBUTIONS BY SETTING THE APPROPRIATE
!        NONCENTRALITY PARAMETERS EQUAL TO ZERO.
!
!        CHECKS ARE MADE TO ASSURE THAT ALL PASSED PARAMETERS ARE
!        WITHIN VALID RANGES AS GIVEN BELOW.  NO UPPER LIMIT IS SET
!        FOR THE NONCENTRALITY PARAMETERS, BUT VALUES UP TO ABOUT
!        10,000 CAN BE HANDLED WITH THE CURRENT DIMENSION LIMITS.  THE
!        COMPUTED VALUE CDFX IS VALID ONLY IF IFLAG=0 ON RETURN.
!
!   NOTE: IN EQUATION 2.2 OF REFERENCE 1 THE AUTHOR HAS MISTAKENLY
!         REVERSED THE ARGUMENTS OF THE INCOMPLETE BETA FUNCTION.
!         THEY SHOULD READ [(M/2)+R,(N/2+S)] WHERE M AND N ARE THE
!         DEGREES OF FREEDOM ASSOCIATED WITH THE NUMERATOR AND
!         DENOMINATOR RESPECTIVELY OF THE F STATISTIC.  TO FURTHER
!         CONFUSE THE ISSUE, THE AUTHOR HAS REVERSED THE USAGE OF
!         M AND N IN SECTION 1 OF THE PAPER.
!
!   NOTE: IN SUBROUTINE EDGEF THE DOUBLE PRECISION CONSTANT DEUFLO IS
!         THE EXPONENTIAL UNDERFLOW LIMIT WHOSE CURRENT VALUE IS SET
!         AT -69D0.  ON A COMPUTER WHERE DEXP(-69D0) CAUSES UNDERFLOW
!         THIS LIMIT SHOULD BE CHANGED.
!
!   SUBPROGRAMS CALLED: CDFBET (BETA C.D.F.)
!                       DGAMLN (DOUBLE PRECISION LOG OF GAMMA FUNCTION)
!                       POISSF, EDGEF (ATTACHED)
!
!   CURRENT VERSION COMPLETED SEPTEMBER 29, 1988
!
!   REFERENCES:
!
!   1. BULGREN, W.G., 'ON REPRESENTATIONS OF THE DOUBLY NONCENTRAL F
!      DISTRIBUTION', JOURNAL OF THE AMERICAN STATISTICAL ASSOCIATION,
!      MARCH 1971, VOLUME 66, NO. 333, PP. 184-186.
!
!   2. ABRAMOWITZ, MILTON, AND STEGUN, IRENE A., 'HANDBOOK OF
!      MATHEMATICAL FUNCTIONS', NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY APPLIED
!      MATHEMATICS SERIES 55, NOVEMBER 1970, P. 944.
!
!   3. REEVE, CHARLES P., 'AN ALGORITHM FOR COMPUTING THE DOUBLY
!      NONCENTRAL F C.D.F. TO A SPECIFIED ACCURACY', STATISTICAL
!      ENGINEERING DIVISION NOTE 86-4, NOVEMBER 1986.
!---------------------------------------------------------------------
!   DEFINITION OF PASSED PARAMETERS:
!
!        * X = VALUE (>=0) AT WHICH THE C.D.F. IS TO BE COMPUTED (REAL)
!
!      * DF1 = DEGREES OF FREEDOM (>0) IN THE NUMERATOR (REAL)
!
!      * DF2 = DEGREES OF FREEDOM (>0) IN THE DENOMINATOR (REAL)
!
!   * ALAMB1 = THE NONCENTRALITY PARAMETER (>=0) FOR THE NUMERATOR
!              (REAL) [EQUAL TO ZERO FOR THE CENTRAL F DISTRIBUTION]
!
!   * ALAMB2 = THE NONCENTRALITY PARAMETER (>=0) FOR THE DENOMINATOR
!              (REAL) [EQUAL TO ZERO FOR THE SINGLY NONCENTRAL F AND
!              CENTRAL F DISTRIBUTIONS]
!
!      * EPS = THE DESIRED ABSOLUTE ACCURACY OF THE C.D.F. (REAL)
!              [1 >= EPS >= 10**(-10)]
!
!      IFLAG = ERROR INDICATOR ON OUTPUT (INTEGER)   INTERPRETATION:
!                0 -> NO ERRORS DETECTED
!              1,2 -> ERROR FLAGS FROM SUBROUTINE CDFBET
!                3 -> EITHER ALAMB1 OR ALAMB2 IS < 0
!                4 -> EITHER DF1 OR DF2 IS <= 0
!                5 -> EPS IS OUTSIDE THE RANGE [10**(-10),1]
!                6 -> VECTOR DIMENSIONS ARE TOO SMALL - INCREASE NX
!
!       CDFX = THE DOUBLY NONCENTRAL F C.D.F. EVALUATED AT X (REAL)
!
...
!
      CDF=0.0
      IF(DF1.LE.0.0)GO TO 50
      IF(DF2.LE.0.0)GO TO 55
      IF(X.LT.0.0)GO TO 60
      IF(ALAMB1.LT.0.0)GO TO 70
      IF(ALAMB2.LT.0.0)GO TO 80
...
!
   90 CONTINUE
!
!CCCC MAY 2004.  INCREASE ERROR CRITIERION.
!CCCC EPS=1.0E-5
      EPS=1.0E-6
!
...
!
 9999 CONTINUE
      RETURN
!
      END SUBROUTINE DNFCDF
      REAL FUNCTION DNFFU3(X)
!
!     PURPOSE--DNTPDF CALLS DIFF TO FIND A NUMERICAL DERIVATIVE FOR
!              THE DOUBLY NON-CENTRAL CUMULATIVE DISTRIBUTION
!              FUNCTION.  DNFFU3 IS A FUNCTION THAT CALL DNFCDF.
!     INPUT  ARGUMENTS--X      = THE SINGLE PRECISION VALUE AT
!                                WHICH THE DERIVATIVE
!                                IS TO BE EVALUATED.
!     OUTPUT--THE SINGLE PRECISION FUNCTION VALUE DNFFU3.
!     PRINTING--NONE.
!     RESTRICTIONS--NONE.
!     OTHER DATAPAC   SUBROUTINES NEEDED--DNFCDF.
!     FORTRAN LIBRARY SUBROUTINES NEEDED--NONE.
!     MODE OF INTERNAL OPERATIONS--SINGLE PRECISION.
!     LANGUAGE--ANSI FORTRAN (1977)
!     WRITTEN BY--JAMES J. FILLIBEN
...
!
!     PURPOSE--PROBABILITY DENSITY FUNCTION FOR THE DOUBLY NON-CENTRAL
!              F DISTRIBUTION.  THE PROBABILITY DENSITY FUNCTION
!              IS COMPUTED BY COMPUTING THE NUMERICAL DERIVATIVE OF
!              THE CUMULATIVE DISTRIBUTION FUNCTION.
!     INPUT  ARGUMENTS--X      = THE SINGLE PRECISION VALUE AT
!                                WHICH THE PROBABILITY DENSITY
!                                FUNCTION IS TO BE EVALUATED.
!                     --NU1    = THE FIRST DEGREES OF FREEDOM PARAMETER
!                     --NU2    = THE SECOND DEGREES OF FREEDOM PARAMETER
!                     --LAMB1  = THE FIRST NON-CENTRALITY PARAMETER
!                     --LAMB2  = THE SECOND NON-CENTRALITY PARAMETER
!     OUTPUT ARGUMENTS--PDF    = THE SINGLE PRECISION PROBABILITY
!                                DENSITY FUNCTION VALUE.
!     OUTPUT--THE SINGLE PRECISION PROBABILITY DENSITY FUNCTION VALUE PDF.
!     PRINTING--NONE.
!     RESTRICTIONS--NONE.
!     OTHER DATAPAC   SUBROUTINES NEEDED--DIFF.
!     FORTRAN LIBRARY SUBROUTINES NEEDED--NONE.
!     MODE OF INTERNAL OPERATIONS--SINGLE PRECISION.
!     LANGUAGE--ANSI FORTRAN (1977)
!     WRITTEN BY--JAMES J. FILLIBEN
...
!
!  FIND NUMERIC DERIVATIVE OF CDF ROUTINE
!
      IORD=1
      EPS=0.001
      ACCUR=0.0
...
!
 9999 CONTINUE
      RETURN
      END SUBROUTINE DNFPDF
      SUBROUTINE DNFPPF(P,DF1,DF2,ALAMB1,ALAMB2,PPF)
!
!     PURPOSE   --PERCENT POINT FUNCTION FOR THE DOUBLY NON-CENTRAL F
...
!
  ...
  302   FORMAT('**** ERROR--THE SECOND NON-CENTRALITY ',   &
      ...
      ENDIF
!
!  FIND BRACKETING INTERVAL.  USE CORRESPONDING CENTRAL F
!  AS INITIAL GUESS, INCREMENTS OF 100 AROUND IT.
...
!
 9999 CONTINUE
      RETURN
      END SUBROUTINE DNFPPF
      SUBROUTINE DNFRAN(N,ANU1,ANU2,ALAMB1,ALAMB2,ISEED,X)
!
!     PURPOSE--THIS SUBROUTINE GENERATES A RANDOM SAMPLE OF SIZE N
!              FROM THE DOUBLY NON-CENTRAL F DISTRIBUTION WITH SHAPE
!              PARAMETERS ANU1 AND ANU2 AND NON-CENTRALITY
!              PARAMETERS LAMBDA1 AND LAMBDA2.
!     INPUT  ARGUMENTS--N      = THE DESIRED INTEGER NUMBER
!                                OF RANDOM NUMBERS TO BE
!                                GENERATED.
...
!                                FIRST  SHAPE PARAMETER.
!                     --ANU2   = THE SINGLE PRECISION VALUE OF THE
!                                SECOND SHAPE PARAMETER.
!                     --ALAMB1 = THE SINGLE PRECISION VALUE OF THE
!                                FIRST NON-CENTRALITY PARAMETER.
!                     --ALAMB2 = THE SINGLE PRECISION VALUE OF THE
...
!                                RANDOM SAMPLE WILL BE PLACED.
!     OUTPUT--A RANDOM SAMPLE OF SIZE N
!             FROM THE DOUBLY NON-CENTRAL F DISTRIBUTION
!             WITH SHAPE PARAMETER VALUES = ANU1, ANU2, ALAMB1, AND
!             ALAMB2.
!     PRINTING--NONE UNLESS AN INPUT ARGUMENT ERROR CONDITION EXISTS.
!     RESTRICTIONS--THERE IS NO RESTRICTION ON THE MAXIMUM VALUE
!                   OF N FOR THIS SUBROUTINE.
!                 --ANU1 AND ANU2  SHOULD BE POSITIVE.
!                 --ALAMB1 AND ALAMB2 SHOULD BE NON-NEGATIVE.
!     OTHER DATAPAC   SUBROUTINES NEEDED--NORRAN, CHSRAN.
!     FORTRAN LIBRARY SUBROUTINES NEEDED--NONE.
!     MODE OF INTERNAL OPERATIONS--SINGLE PRECISION.
!     LANGUAGE--ANSI FORTRAN (1977)
!     REFERENCES--JOHNSON, KOTZ, AND BALAKRISHNAN, "CONTINUOUS
...
!
    ...
    5 FORMAT('***** ERROR--THE REQUESTED NUMBER OF DOUBLY ',   &
      'NON-CENTRAL F RANDOM NUMBERS IS NON-POSITIVE.')
      IF(ANU1.LE.0.0)THEN
        WRITE(ICOUT,16)
        CALL DPWRST('XXX','BUG ')
        WRITE(ICOUT,46)ANU1
   ...
   16 FORMAT('***** ERROR--THE SHAPE PARAMETER NU1 FOR THE ',   &
      'DOUBLY NON-CENTRAL F RANDOM NUMBERS IS NON-POSITIVE.')
      IF(ANU2.LE.0.0)THEN
        WRITE(ICOUT,26)
        CALL DPWRST('XXX','BUG ')
        WRITE(ICOUT,46)ANU2
   ...
   36 FORMAT('***** ERROR--THE NON-CENTRALITY PARAMETER LAMBDA1 FOR ',   &
      'THE DOUBLY NON-CENTRAL F RANDOM NUMBERS IS NEGATIVE.')
!
      IF(ALAMB2.LT.0.0)THEN
        WRITE(ICOUT,38)
        CALL DPWRST('XXX','BUG ')
   ...
   47 FORMAT('***** THE VALUE OF THE ARGUMENT IS ',I8)
!
!  IF DEGREES OF FREEDOM ARE LESS THAN 1, THEN USE PERCENT
!  POINT METHOD (PROBABLY NOT MOST EFFICIENT METHOD, BUT LEAVE
!  UNTIL FIND A BETTER ALGORITHM).
!
...
!
 9000 CONTINUE
      RETURN
      END SUBROUTINE DNFRAN
      SUBROUTINE DNTCDF(X, DF, DELTA, ALAMB, CDF)
!CCCC CONVERT TO DOUBLE PRECISION.  SINGLE PRECISION GIVES INACCURATE
!CCCC RESULTS ON A 32-BIT COMPUTER.
!
!--------------------------------------------------------------------
!   CDFDNT   WRITTEN BY CHARLES P. REEVE, STATISTICAL ENGINEERING
!            DIVISION, NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY, GAITHERSBURG,
!            MARYLAND  20899
!
!   FOR: COMPUTING THE CUMULATIVE DISTRIBUTION FUNCTION OF THE DOUBLY
!        NONCENTRAL T DISTRIBUTION TO A SPECIFIED ACCURACY (TRUNCATION
!        ERROR IN THE INFINITE SERIES REPRESENTATION GIVEN BY EQUATION
!        4 IN REFERENCE 1 BELOW).  WHEN X<0 THE C.D.F. IS COMPUTED
!        FROM CDF(X,DF,DELTA,ALAMB) = 1 - CDF(-X,DF,-DELTA,ALAMB).
!        THE BETA C.D.F. ROUTINE IS CALLED AT MOST FOUR TIMES.  FURTHER
!        VALUES OF THE BETA C.D.F. ARE OBTAINED FROM RECURRENCE
!        RELATIONS GIVEN IN REFERENCE 2.  REFERENCE 3 GIVES A DETAILED
!        DESCRIPTION OF THE ALGORITHM HEREIN.
!
!        THIS PROGRAM MAY ALSO BE EFFICIENTLY USED TO COMPUTE THE
!        CUMULATIVE DISTRIBUTION FUNCTIONS OF THE SINGLY NONCENTRAL
!        AND CENTRAL T DISTRIBUTIONS BY SETTING THE APPROPRIATE
!        NONCENTRALITY PARAMETERS EQUAL TO ZERO.
!
!        CHECKS ARE MADE TO ASSURE THAT ALL PASSED PARAMETERS ARE
!        WITHIN VALID RANGES AS GIVEN BELOW.  NO UPPER LIMIT IS SET
!        FOR THE NONCENTRALITY PARAMETERS, BUT VALUES UP TO ABOUT 100
!        FOR DELTA AND 10,000 FOR LAMBDA CAN BE HANDLED WITH THE
!        CURRENT DIMENSION LIMITS.  THE COMPUTED VALUE CDF IS VALID
!        ONLY IF IFLAG=0 ON RETURN.
!
!   NOTE: IN SUBROUTINE EDGET THE DOUBLE PRECISION CONSTANT DEUFLO IS
!         THE EXPONENTIAL UNDERFLOW LIMIT WHOSE CURRENT VALUE IS SET
!         AT -69D0.  ON A COMPUTER WHERE DEXP(-69D0) CAUSES UNDERFLOW
!         THIS LIMIT SHOULD BE CHANGED.
!
!   SUBPROGRAMS CALLED: BETCDF (BETA C.D.F.)
!                       DLNGAM (DOUBLE PRECISION LOG OF GAMMA FUNCTION)
!                       POISST, EDGET, GRID
!
!   CURRENT VERSION COMPLETED SEPTEMBER 29, 1988
!
!   REFERENCES:
!
!   1. KRISHNAN, MARAKATHA, 'SERIES REPRESENTATIONS OF THE DOUBLY
!      NONCENTRAL T DISTRIBUTION', JOURNAL OF THE AMERICAN STATISTICAL
!      ASSOCIATION, SEPTEMBER 1968, VOLUME 63, NO. 323, PP. 1004-1012.
!
!   2. ABRAMOWITZ, MILTON, AND STEGUN, IRENE A., 'HANDBOOK OF
!      MATHEMATICAL FUNCTIONS', NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY APPLIED
!      MATHEMATICS SERIES 55, NOVEMBER 1970, P. 944.
!
!   3. REEVE, CHARLES P., 'AN ALGORITHM FOR COMPUTING THE DOUBLY
!      NONCENTRAL T C.D.F. TO A SPECIFIED ACCURACY', STATISTICAL
!      ENGINEERING DIVISION NOTE 86-5, DECEMBER 1986.
!--------------------------------------------------------------------
!   DEFINITION OF PASSED PARAMETERS:
!
!       * X = VALUE AT WHICH THE C.D.F. IS TO BE COMPUTED (REAL)
!
!      * DF = DEGREES OF FREEDOM (>0) IN THE DENOMINATOR (REAL)
!
!   * DELTA = THE NONCENTRALITY PARAMETER FOR THE NUMERATOR (REAL)
!             [EQUAL TO ZERO FOR THE CENTRAL T DISTRIBUTION]
!
!   * ALAMB = THE NONCENTRALITY PARAMETER (>=0) FOR THE DENOMINATOR
!             (REAL) [EQUAL TO ZERO FOR THE SINGLY NONCENTRAL T AND
!             CENTRAL T DISTRIBUTIONS]
!
!     * EPS = THE DESIRED ABSOLUTE ACCURACY OF THE C.D.F. (REAL)
!             [1 >= EPS >= 10**(-10)]
!             (NOTE: WE WILL HARD CODE THIS TO 1.0E-6)
!
!      CDF = THE DOUBLY NONCENTRAL T C.D.F. EVALUATED AT X (REAL)
!
!   * INDICATES PARAMETERS REQUIRING INPUT VALUES
!--------------------------------------------------------------------
!
...
!
      PARAMETER (NX=1000)
      DIMENSION BFI(NX),BFJ(NX),POI(NX),POJ(NX)
!CCCC DOUBLE PRECISION DARG,DFA
      LOGICAL LL
!
!---------------------------------------------------------------------
!
      INCLUDE 'DPCOP2.INC'
!
!CCCC MAY 2004.  INCREASE ACCURACY
!CCCC DATA EPS/1.D-06/
      DATA EPS/1.D-08/
!
      DCDF=0.D0
      IF(DF.LE.0.0)THEN
...
!--- IDENTITY DESCRIBED UP FRONT FOR COMPUTING THE C.D.F.
!
      LL = X.LT.0.0D0
      IF (XX.GE.1.0D0) THEN
         DCDF = 1.0D0
...
!CCCC    IF (IFLAG.NE.0) RETURN
      ...
      ENDIF
!
!--- COMPUTE THE NORMAL C.D.F. AT -SDELTA
!
   40 PHI = 0.5D0*(1.0D0-SUM)
!
!--- COMPUTE THE DOUBLY NONCENTRAL T C.D.F. AT X, USING AN IDENTITY
!--- IF X<0
!
      DCDF = 0.5D0*DCDF+PHI
...
!
 9999 CONTINUE
      CDF=SNGL(DCDF)
      RETURN
      END SUBROUTINE DNTCDF
      REAL FUNCTION DNTFU3(X)
!
!     PURPOSE--DNTPDF CALLS DIFF TO FIND A NUMERICAL DERIVATIVE
!              FOR THE NON-CENTRAL CUMULATIVE DISTRIBUTION FUNCTION.
!              DNTFU3 IS A FUNCTION THAT CALL DNTCDF.
!     INPUT  ARGUMENTS--X      = THE SINGLE PRECISION VALUE AT
!                                WHICH THE DERIVATIVE
!                                IS TO BE EVALUATED.
!     OUTPUT--THE SINGLE PRECISION FUNCTION VALUE DNTFU3.
!     PRINTING--NONE.
!     RESTRICTIONS--NONE.
!     OTHER DATAPAC   SUBROUTINES NEEDED--NCBCDF.
!     FORTRAN LIBRARY SUBROUTINES NEEDED--NONE.
!     MODE OF INTERNAL OPERATIONS--SINGLE PRECISION.
!     LANGUAGE--ANSI FORTRAN (1977)
!     WRITTEN BY--JAMES J. FILLIBEN
...
!
!     PURPOSE--PROBABILITY DENSITY FUNCTION FOR THE NON-CENTRAL
!              T DISTRIBUTION.  THE PROBABILITY DENSITY FUNCTION
!              IS COMPUTED BY COMPUTING THE NUMERICAL DERIVATIVE OF
!              THE CUMULATIVE DISTRIBUTION FUNCTION.
!     INPUT  ARGUMENTS--X      = THE SINGLE PRECISION VALUE AT
!                                WHICH THE PROBABILITY DENSITY
!                                FUNCTION IS TO BE EVALUATED.
!                     --ANU    = THE DEGREES OF FREEDOM SHAPE PARAMETER
!                     --DELTA  = THE FIRST NON-CENTRALITY SHAPE PARAMETER
!                     --LAMBDA = THE SECOND NON-CENTRALITY PARAMETER
!     OUTPUT ARGUMENTS--PDF    = THE SINGLE PRECISION PROBABILITY
!                                DENSITY FUNCTION VALUE.
!     OUTPUT--THE SINGLE PRECISION PROBABILITY DENSITY FUNCTION VALUE PDF.
!     PRINTING--NONE.
...
!
 9999 CONTINUE
      RETURN
      END SUBROUTINE DNTPDF
      SUBROUTINE DNTPPF(P,NU,DELTA,ALAMB,PPF)
!
!     PURPOSE   --PERCENT POINT FUNCTION FOR THE DOUBLY NON-CENTRAL T
!                 DISTRIBUTION.  USES A BISECTION METHOD.
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
...
!
  ...
  201   FORMAT('**** ERROR--THE FIRST NON-CENTRALITY PARAMETER ',   &
               'FOR DNTPPF HAS AN ABSOLUTE VALUE GREATER THAN 100.')
        CALL DPWRST('XXX','BUG ')
  ...
  301   FORMAT('**** ERROR--THE SECOND NON-CENTRALITY PARAMETER ',   &
               'FOR DNTPPF HAS AN ABSOLUTE VALUE GREATER THAN 10000.')
        CALL DPWRST('XXX','BUG ')
      ...
      ENDIF
!
!  FIND BRACKETING INTERVAL.  USE CORRESPONDING CENTRAL CHI-SQUARE
!  AS INITIAL GUESS, INCREMENTS OF 100 AROUND IT.
!  AFTER SUCCESSFULLY FIND BRACKETING INTERVAL, THEN SWITCH TO
!  MORE EFFICIENT BISECTION METHOD.
!
...
!
 9999 CONTINUE
      RETURN
      END SUBROUTINE DNTPPF
      SUBROUTINE DNTRAN(N,ANU,DELTA,LAMBDA,ISEED,X)
!
!     PURPOSE--THIS SUBROUTINE GENERATES A RANDOM SAMPLE OF SIZE N
!              FROM THE STUDENT'S DOUBLY NON-CENTRAL T DISTRIBUTION
!              WITH INTEGER DEGREES OF FREEDOM PARAMETER NU AND
!              NON-CENTRALITY PARAMETERS DELTA AND LAMBDA.
!     INPUT  ARGUMENTS--N      = THE DESIRED INTEGER NUMBER
!                                OF RANDOM NUMBERS TO BE
!                                GENERATED.
!                     --NU     = THE INTEGER DEGREES OF FREEDOM
!                                PARAMETER.
!                     --DELTA  = THE REAL NON-CENTRALITY PARAMETER
!                                DELTA.
!                     --LAMBDA = THE REAL NON-CENTRALITY PARAMETER
!                                LAMBDA.
!     OUTPUT ARGUMENTS--X      = A SINGLE PRECISION VECTOR
!                                (OF DIMENSION AT LEAST N)
!                                INTO WHICH THE GENERATED
...
!     OUTPUT--A RANDOM SAMPLE OF SIZE N
!             FROM THE STUDENT'S DOUBLY NON-CENTRAL T DISTRIBUTION
!             WITH DEGREES OF FREEDOM PARAMETER = NU AND
!             NON-CENTRALITY PARAMETERS DELTA AND LAMBDA.
!     PRINTING--NONE UNLESS AN INPUT ARGUMENT ERROR CONDITION EXISTS.
!     RESTRICTIONS--THERE IS NO RESTRICTION ON THE MAXIMUM VALUE
!                   OF N FOR THIS SUBROUTINE.
...
!
    ...
    5   FORMAT('***** ERROR--THE REQUESTED NUMBER OF DOUBLY NONCENTRAL',   &
               ' T RANDOM NUMBERS IS NON-POSITIVE.')
        CALL DPWRST('XXX','BUG ')
        WRITE(ICOUT,47)N
   47   FORMAT('***** THE VALUE OF THE ARGUMENT IS ',I8,'.')
        CALL DPWRST('XXX','BUG ')
   ...
   15   FORMAT('***** ERROR--THE DEGREES OF FREEDOM PARAMETER FOR THE ',   &
               'DOUBLY NON-CENTRAL T RANDOM NUMBERS IS NON-POSITIVE.')
        CALL DPWRST('XXX','BUG ')
        WRITE(ICOUT,48)ANU
   48   FORMAT('***** THE VALUE OF THE ARGUMENT IS ',F12.5,'.')
      ...
      ENDIF
!
!     GENERATE N STUDENT'S DOUBLY NON-CENTRAL T RANDOM NUMBERS
!     USING THE DEFINITION THAT A STUDENT'S DOUBLY NON-CENTRAL T
!     VARIATE WITH NU DEGREES OF FREEDOM AND NON-CENTRALITY
!     PARAMETERS DELTA AND LAMBDA EQUALS A NORMAL VARIATE WITH
!     LOCATION PARAMETER DELTA DIVIDED BY
!     SQRT(NON-CENTRAL-CHI-SQUARED(NU,LAMBDA)/NU).
!     FIRST GENERATE A NORMAL RANDOM NUMBER WITH LOCATION PARAMETER
!     DELTA, THEN GENERATE THE NON-CENTRAL CHI-SQUARE NUMBER.
!     THEN FORM THE RATIO OF THE FIRST DIVIDED BY THE SECOND.
!
      DO 100 I=1,N
!
!       NORMAL RANDOM NUMBER WITH LOCATION PARAMETER DELTA
!
...
!
!       NON-CENTRAL CHI-SQUARE RANDOM NUMBER
!
...
!DPLT CALL TREGUP(NR,N,X,F,G,A,OPTFCN,SC,SX,NWTAKE,STEPMX,STEPTL,DLT,
      ...
      GO TO 100
!C950 FORMAT(42H DOGDRV    INITIAL TRUST REGION NOT GIVEN.,
!C   +       22H  COMPUTE CAUCHY STEP.)
!C951 FORMAT(18H DOGDRV    ALPHA =,E20.13/
!C   +       18H DOGDRV    BETA  =,E20.13/
!C   +       18H DOGDRV    DLT   =,E20.13/
!C   +       18H DOGDRV    NWTAKE=,L1    )
!C952 FORMAT(28H DOGDRV    CURRENT STEP (SC))
!C954 FORMAT(18H0DOGDRV    RNWTLN=,E20.13)
!C955 FORMAT(14H DOGDRV       ,5(E20.13,3X))
...
!$    WRITE(IPR,960) (SC(I),I=1,N)
      RETURN
!
!C951 FORMAT(27H0DOGSTP    TAKE NEWTON STEP)
!C952 FORMAT('DOGSTP    FSTDOG=',L1/
!CCCC+       'DOGSTP    NWTAKE=',L1/
!CCCC+       'DOGSTP    RNWTLN=',E20.13/
!CCCC+       'DOGSTP    DLT   =',E20.13)
!C953 FORMAT('DOGSTP    CURRENT STEP (SC)')
!C954 FORMAT('DOGSTP    ALPHA =',E20.13/
!CCCC+       'DOGSTP    BETA  =',E20.13/
!CCCC+       'DOGSTP    CLN   =',E20.13/
!CCCC+       'DOGSTP    ETA   =',E20.13)
!C955 FORMAT('DOGSTP    CAUCHY STEP (SSD)')
!C956 FORMAT('DOGSTP    V')
!C957 FORMAT(48H0DOGSTP    TAKE PARTIAL STEP IN NEWTON DIRECTION)
!C958 FORMAT('DOGSTP    TAKE STEP IN STEEPEST DESCENT DIRECTION')
!C959 FORMAT('DOGSTP    TAKE CONVEX COMBINATION STEP')
!C960 FORMAT('DOGSTP       ',5(E20.13,3X))
      END SUBROUTINE DOGSTP
      SUBROUTINE DOTPRO(V1,V2,N,DP)
!
!     PURPOSE--TO COMPUTE THE DOT PRODUCT
!              BETWEEN 2 SINGLE-PRECISION VECTORS--
!              V1 AND V2.
!              THE OUTPUT WILL BWE THE SINGLE PRECISION VALUE DP.
!              ALL INTERNAL CALCULATIONS ARE CARRIED
!              OUT IN DOUBLE PRECISION.T
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
!                 NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY
...
!
      ...
      SUBROUTINE DP1H4H(ISTART,ISTOP,ISTRIN,   &
                        IWORD1,IWORD2,IWORD3,NUMWD,NUMCH,IBUG1H,IERROR)
!
!     PURPOSE--CONVERT THE STRING FOUND IN LOCATIONS ISTART
!              THROUGH ISTOP (INCLUSIVE) IN ISTRIN(.).
!              FROM 1 CHARACTER PER WORD REPRESENTATIONS
!              TO PACKED 4 CHARACTERS PER WORD REPRESENTATIONS
!              IN IWORD1, IWORD2, AND IWORD3.
!     NOTE--AT MOST 12 CHARACTERS WILL BE OPERATED ON.
!     NOTE--AT MOST 3 WORDS WILL BE FORMED.
!
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
...
!
      DIMENSION ISTRIN(*)
!
!     NUMBPC = NUMBER OF BITS PER CHARACTER.
!     NUMCPW = NUMBER OF CHARACTERS PER WORD.
!     THESE VALUES WILL CHANGE DEPENDING
!     ON THE COMPUTER AND ARE DEFINED IN THE SUBROUTINE INITMC.
!     HOWEVER, IN ANY EVENT, THE OUTPUT FROM THIS
!     SUBROUTINE WILL BE 4 CHARACTERS PER WORD
!     (FOR A MORE GENERAL SUBROUTINE, SEE DP1HXH).
!
!---------------------------------------------------------------------
!
      INCLUDE 'DPCOP2.INC'
...
!
      ...
      K=NUMBPC*(L-1)
      K=IABS(K)
      IF(I1MIN.LE.J.AND.J.LE.I1MAX)GO TO 211
      IF(I2MIN.LE.J.AND.J.LE.I2MAX)GO TO 212
      IF(I3MIN.LE.J.AND.J.LE.I3MAX)GO TO 213
      GO TO 250
  211 CONTINUE
...
!
      DOUBLE PRECISION A, X, ABSA, ABSX, ALNEPS, ALNVAR, B, BERN(20),   &
        ...
        SQTBIG, TERM, TRIG, VAR, VAR2, DPSI, DEXPRL, DCOT, DPOCH
      LOGICAL FIRST
      EXTERNAL DCOT
...
!CCCC+   'NTERMS IS TOO BIG, MAYBE D1MACH(3) IS BAD', 1, 2)
...
!
      ...
      SUBROUTINE DP3DP1(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                        MAXNPP,   &
                        IBUGG3,IBUGQ,IFOUND,IERROR)
!
!     DONE?
!     PURPOSE--FORM A PARTICULAR 3-DIMENSIONAL PLOT--
!              NAMELY, A Y VERSUS X1 AND X2 PLOT,
!              WHEN HAVE NO VERSUS AND NO EQUALS.
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
!                 NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY
...
!               ********************************
!               **  STEP 10--                 **
!               **  TREAT THE CASE WHEN HAVE  **
!               **  NO    VERSUS        AND   **
!               **  NO    FOR X =             **
!               ********************************
!
      IF(IBUGG3.EQ.'OFF')GO TO 90
      WRITE(ICOUT,999)
  999 FORMAT(1X)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,51)
...
!
      ICASEQ='FULL'
      ILOCQ=NUMARG+1
      IF(NUMARG.LT.1)GO TO 1290
      DO 1200 J=1,NUMARG
      J1=J
      IF(IHARG(J).EQ.'SUBS'.AND.IHARG2(J).EQ.'ET  ') GO TO 1210
      IF(IHARG(J).EQ.'EXCE'.AND.IHARG2(J).EQ.'PT  ') GO TO 1210
      IF(IHARG(J).EQ.'FOR '.AND.IHARG2(J).EQ.'    ') GO TO 1220
 1200 CONTINUE
      GO TO 1290
 1210 CONTINUE
      ICASEQ='SUBS'
...
!
      ...
      IF(IBUGG3.EQ.'ON')CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
      IF(ICASEQ.EQ.'FULL')GO TO 1310
      IF(ICASEQ.EQ.'SUBS')GO TO 1320
      IF(ICASEQ.EQ.'FOR')GO TO 1330
!
 1310 CONTINUE
      DO 1315 I=1,NLOCAL
      ISUB(I)=1
...
!               **********************************************************
!               **  STEP 14--                                           **
!               **  BRANCH ACCORDING TO THE NUMBER OF ARGUMENTS BEFORE  **
!               **  'SUBS', 'FOR', AND 'AND'.                          **
!               **********************************************************
!
      ISTEPN='14'
...
!
      ...
      IF(NUMAR1.EQ.3)GO TO 1700
      IF(NUMAR1.EQ.4)GO TO 1800
      WRITE(ICOUT,1401)
...
!               *************************************************************
!               **  STEP 17--                                              **
!               **  TREAT THE 3 VARIABLE CASE (WITH NO VS AND NO =) CASE.  **
!               *************************************************************
!
 1700 CONTINUE
      ISTEPN='17'
...
!
      ...
      IHNAME,IHNAM2,IUSE,IN,IVALUE,VALUE,NUMNAM,MAXNAM,   &
      ISUBN1,ISUBN2,MESSAG,IANS,IWIDTH,ILOCH,IERROR)
      IF(IERROR.EQ.'YES')GO TO 9000
      IHAV=IVALUE(ILOCH)
!
!               ****************************************
...
!
      ...
      IHNAME,IHNAM2,IUSE,IN,IVALUE,VALUE,NUMNAM,MAXNAM,   &
      ISUBN1,ISUBN2,MESSAG,IANS,IWIDTH,ILOCH2,IERROR)
      IF(IERROR.EQ.'YES')GO TO 9000
      IHAV2=IVALUE(ILOCH2)
!
!               *************************************************************
!               **  STEP 17.4--                                            **
!               **  FORM THE VERTICAL AND 2 HORIZONTAL AXIS                **
!               **  VARIABLES (Y(.)AND X(.) AND X3D(.), RESPECTIVELY)      **
!               **  FOR THE PLOT.                                          **
!               **  RESET THE D(.) VECTOR TO ONES.                         **
...
!
      ...
      IF(IBUGG3.EQ.'ON')CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
      IF(IAND1.EQ.'NO')GO TO 1719
      IF(NPLOTP.LE.0)GO TO 1719
      D1MAX=D(1)
      DO 1710 I=1,NPLOTP
...
!
      NLOCAL=IN(ILOCV)
      DO 1720 I=1,NLOCAL
      IF(ISUB(I).EQ.0)GO TO 1720
      L=L+1
!
      IF(L.LE.MAXNPP)GO TO 1729
      IERROR='YES'
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,1721)
...
!               *************************************************************
!               **  STEP 18--                                              **
!               **  TREAT THE 4 VARIABLE CASE (WITH NO VS AND NO =) CASE.  **
!               *************************************************************
!
 1800 CONTINUE
      ISTEPN='18'
...
!
      ...
      IHNAME,IHNAM2,IUSE,IN,IVALUE,VALUE,NUMNAM,MAXNAM,   &
      ISUBN1,ISUBN2,MESSAG,IANS,IWIDTH,ILOCD,IERROR)
      IF(IERROR.EQ.'YES')GO TO 9000
      ISETV=IVALUE(ILOCD)
!
!               *************************************************************
...
!
      ...
      IF(IBUGG3.EQ.'ON')CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
      IF(IAND1.EQ.'NO')GO TO 1819
      IF(NPLOTP.LE.0)GO TO 1819
      D1MAX=D(1)
      DO 1810 I=1,NPLOTP
      IF(D(I).GT.D1MAX)D1MAX=D(I)
 1810 CONTINUE
      ...
      DO 1811 I=1,NLOCAL
      IJ=MAXN*(ISETV-1)+I
      IF(ISETV.LE.MAXCOL)GO TO 1812
      IF(ISETV.EQ.MAXCP1)GO TO 1813
      IF(ISETV.EQ.MAXCP2)GO TO 1814
      IF(ISETV.EQ.MAXCP3)GO TO 1815
      IF(ISETV.EQ.MAXCP4)GO TO 1816
      IF(ISETV.EQ.MAXCP5)GO TO 1817
      IF(ISETV.EQ.MAXCP6)GO TO 1818
 1812 CONTINUE
...
!
      NLOCAL=IN(ILOCV)
      DO 1820 I=1,NLOCAL
      IF(ISUB(I).EQ.0)GO TO 1820
      L=L+1
!
      IF(L.LE.MAXNPP)GO TO 1829
      IERROR='YES'
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,1821)
...
!
      RETURN
      END SUBROUTINE DP3DP1
      SUBROUTINE DP3DP2(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                        IVSLOC,NUMVS,   &
                        MAXNPP,   &
                        IBUGG3,IBUGQ,IFOUND,IERROR)
!
!     PURPOSE--FORM VARIOUS 3-DIMENSIONAL PLOTS
!              WHEN HAVE 1 OR MORE VERSUS ENTERED.
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
!                 NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY
...
!               *********************************************************
!               **  STEP 20--                                          **
!               **  TREAT THE CASE WHEN HAVE 1 OR MORE 'VERSUS' ENTERED**
!               *********************************************************
!
...
!
      ...
      IF(IHARG(J).EQ.'FOR '.AND.IHARG2(J).EQ.'    ') GO TO 2120
 2100 CONTINUE
      GO TO 2190
 2110 CONTINUE
      ICASEQ='SUBS'
...
!
      ISETV=NEWSET
!
      IF(IAND1.EQ.'NO')GO TO 2280
      IF(NPLOTP.LE.0)GO TO 2280
      D1MAX=D(1)
      DO 2220 I=1,NPLOTP
      IF(D(I).GT.D1MAX)D1MAX=D(I)
 2220 CONTINUE
...
!               **  DEPENDING ON THE TYPE OF CASE          **
!               **  FOR THE QUALIFIER.                     **
!               **  BRANCH TO THE PRPPER CASE.             **
!               *********************************************
!
      ISTEPN='23'
      IF(IBUGG3.EQ.'ON')CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
      IF(ICASEQ.EQ.'FULL')GO TO 2310
      IF(ICASEQ.EQ.'SUBS')GO TO 2320
      IF(ICASEQ.EQ.'FOR')GO TO 2330
!CCCC IF(IHARG(J).EQ.'SUBS'.AND.IHARG2(J).EQ.'ET  ') GO TO 2320
!CCCC IF(IHARG(J).EQ.'EXCE'.AND.IHARG2(J).EQ.'PT  ') GO TO 2320
!CCCC IF(IHARG(J).EQ.'FOR '.AND.IHARG2(J).EQ.'    ') GO TO 2330
!
 2310 CONTINUE
      DO 2315 I=1,NLOCAL
      ISUB(I)=1
...
!
      DO 2360 I=1,NLOCAL
      IF(ISUB(I).EQ.0)GO TO 2360
      L=L+1
!
      IF(L.LE.MAXNPP)GO TO 2369
      WRITE(ICOUT,2362)
...
!
      RETURN
      END SUBROUTINE DP3DP2
      SUBROUTINE DP3DP3(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                        PARAM,IPARN,IPARN2,NUMPAR,ITYPEH,IW2HOL,IW22HO,   &
                        W2HOLD,NWHOLD,   &
                        IFOLOC,MAXNPP,IANGLU,IFORSW,   &
                        IBUGG3,IBUGCO,IBUGEV,IBUGQ,ISUBRO,IFOUND,IERROR)
!
!     PURPOSE--FORM THE 3-DIMENSIONAL PLOT OF A 2-VARIABLE FUNCTION
!              (THAT IS, FORM TRACES FROM A SURFACE)
!              WHEN HAVE 1 OR MORE    =    ENTERED,
!              THAT IS, WHEN HAVE   PLOT Y = ... FOR X = ...
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
!                 NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY
...
!     UPDATED         --MARCH     1982.
!     UPDATED         --MAY       1982.
!     UPDATED         --APRIL     1992. FIX   PLOT CONSTANT
...
!
      DEL=0.0
!
!     CHECK IF FIRST ARGUMENT IS A FUNCTION BLOCK NAME
!
      IFLGFB=0
      IFBNAM=' '
      IFBANS=' '
...
!
!               *********************************************************
!               **  TREAT THE CASE WHEN HAVE 1 OR MORE '=' ENTERED     **
!               **  THAT IS, TREAT THE 3D-PLOT Y = ... FOR X = ... CASE**
!               *********************************************************
!
...
!               *******************************************
!               **  STEP 2--                             **
!               **  DETERMINE THE MAX TRACE DESIGNATION  **
...
!
      IF(IAND1.EQ.'NO')GO TO 119
      IF(NPLOTP.LE.0)GO TO 119
      D1MAX=D(1)
      DO 110 I=1,NPLOTP
        IF(D(I).GT.D1MAX)D1MAX=D(I)
  110 CONTINUE
...
!               *******************************************************
!               **  STEP 3--                                        **
!               **  DETERMINE THE NAME OF THE FIRST  DUMMY VARIABLE  **
!               **  (IT NEVER GETS STORED PERMANENTLY)               **
!               **  IMMEDIATELY FOLLOWING THE FIRST  'FOR' KEYWORD   **
!               *******************************************************
!
      ISTEPN='3'
      IF(IBUGG3.EQ.'ON' .OR. ISUBRO.EQ.'3DP3')   &
...
!               *******************************************************
!               **  STEP 3.1--                                       **
!               **  DETERMINE THE NAME OF THE SECOND DUMMY VARIABLE  **
!               **  (IT NEVER GETS STORED PERMANENTLY)               **
!               **  IMMEDIATELY FOLLOWING THE SECOND 'FOR' KEYWORD   **
!               *******************************************************
!
      ISTEPN='3.1'
      IF(IBUGG3.EQ.'ON' .OR. ISUBRO.EQ.'3DP3')   &
...
!
      IFOLP6=IFOLP0+6
      IF(IFOLP6.GT.NUMARG)GO TO 3159
      DO 3150 J=IFOLP6,NUMARG
        J2=J
        IF(IHARG(J).EQ.'FOR')GO TO 3169
 3150 CONTINUE
 3159 CONTINUE
!
      IBRAN=3161
...
!               **  THE VARIOUS POINTS IN THE INTERVAL.  **
!               *******************************************
!
      ISTEPN='4'
      IF(IBUGG3.EQ.'ON' .OR. ISUBRO.EQ.'3DP3')   &
...
!
 3280 CONTINUE
      IF(START1.NE.STOP1.AND.AINC1.NE.0.0)GO TO 3297
      IF(START2.NE.STOP2.AND.AINC2.NE.0.0)GO TO 3297
!
      WRITE(ICOUT,3281)
 ...
 3294 FORMAT('      RESULTING ACTION--ONLY A SINGLE POINT ',   &
             'WAS OUTPUTTED FOR PLOTTING.')
      CALL DPWRST('XXX','BUG ')
      NUMIT1=1
      GO TO 3299
 3297 CONTINUE
!
!     *****THE FOLLOWING CORRECTIVE LINE ADDED AUGUST 1983*****
...
!     *****THE FOLLOWING 2 CORRECTIVE LINES ADDED AUGUST 1983*****
...
!
      ...
      IFUNC2,N2F,IBUGG3,IFOUND,IERROR)
      IF(IERROR.EQ.'YES')GO TO 9000
...
!               ***********************************************************
!               **  STEP 5.1--                                           **
!               **  FIRST CHECK TO SEE IF HAVE THE VERTICAL LINES CASE;  **
!               **  THEN EXTRACT THE UNDERLYING FUNCTION FROM            **
...
!
      IVERTI='NO'
      DO 3380 I=1,NUMARG
        IF(IHARG(I).EQ.'VERT'.AND.IHARG2(I).EQ.'ICAL')GO TO 3385
 3380 CONTINUE
      GO TO 3389
 3385 CONTINUE
!
      IMAX=N2F-12
      IF(IMAX.LE.0)GO TO 3389
      DO 3386 I=1,IMAX
      IP1=I+1
      IP2=I+2
      IP3=I+3
      ...
      IP6=I+6
      IP7=I+7
      IF(IFUNC2(I).NE.'V')GO TO 3386
      IF(IFUNC2(IP1).NE.'E')GO TO 3386
      IF(IFUNC2(IP2).NE.'R')GO TO 3386
      IF(IFUNC2(IP3).NE.'T')GO TO 3386
      IF(IFUNC2(IP4).NE.'I')GO TO 3386
      IF(IFUNC2(IP5).NE.'C')GO TO 3386
      IF(IFUNC2(IP6).NE.'A')GO TO 3386
      IF(IFUNC2(IP7).NE.'L')GO TO 3386
      IVERTI='YES'
      N2F=I-1
      GO TO 3389
 3386 CONTINUE
...
!
        ...
        IF(NUMPV.GE.1)THEN
          DO 3600 J=1,NUMPV
            IHPARN=IPARN(J)
            IHPAR2=IPARN2(J)
            IF(IHPARN.EQ.IVDU11.AND.IHPAR2.EQ.IVDU12)GO TO 3620
            IF(IHPARN.EQ.IVDU21.AND.IHPAR2.EQ.IVDU22)GO TO 3630
            IHWUSE='P'
            MESSAG='YES'
...
!
 3600     CONTINUE
        ENDIF
!CCCC   THE FOLLOWING 10 LINES WERE ADDED   APRIL 1992 (JJF)
        IF(LOCDU1.LE.0)THEN
           IV=IV+1
           NUMPV=NUMPV+1
           LOCDU1=NUMPV
...
!
        IF(I1.GT.1)THEN
          IF(START1.LT.STOP1.AND.RESUL1.GT.STOP1)GO TO 3818
          IF(START1.GT.STOP1.AND.RESUL1.LT.STOP1)GO TO 3818
        ENDIF
        ISET=ISET+1
!
        DO 3820 I2=1,NUMIT2
...
!
          IF(I2.EQ.1)GO TO 3829
          IF(START2.LT.STOP2.AND.RESUL2.GT.STOP2)GO TO 3828
          IF(START2.GT.STOP2.AND.RESUL2.LT.STOP2)GO TO 3828
 3829     CONTINUE
          L2=L2+1
!
...
!
          IF(IFLGFB.LE.0)THEN
            ...
            PARAM(LOCDU2)=YTEMP
            CALL COMPIM(IFUNC3,N3F,IPASS,PARAM,IPARN,IPARN2,NUMPV,   &
                        IANGLU,ITYPEH,IW2HOL,IW22HO,W2HOLD,NWHOLD,ZTEMP,   &
                        IBUGCO,IBUGEV,IERROR)
            IF(IERROR.EQ.'YES')GO TO 9000
          ELSE
!
...
!
            DO 3901 KK=1,2
              ...
              IF(IHARG(1).EQ.IFBNA1(1:4) .AND.   &
                 IHARG2(1).EQ.IFBNA1(5:8))THEN
                IH=IFBPL1(KK)(1:4)
                IH2=IFBPL1(KK)(5:8)
              ELSEIF(IHARG(1).EQ.IFBNA2(1:4) .AND.   &
                     IHARG2(1).EQ.IFBNA2(5:8))THEN
                IH=IFBPL2(KK)(1:4)
                IH2=IFBPL2(KK)(5:8)
              ELSEIF(IHARG(1).EQ.IFBNA3(1:4) .AND.   &
                     IHARG2(1).EQ.IFBNA3(5:8))THEN
                IH=IFBPL3(KK)(1:4)
                IH2=IFBPL3(KK)(5:8)
              ENDIF
!
...
!
            CALL DPFBEX(IFBNAM,IANGLU,ISEED,IFTEXP,IFTORD,IFORSW,   &
                        IBUGG3,IBUGG3,IBUGCO,IBUGEV,IBUGEV,   &
...
!
      DO 3910 I2=1,NUMIT2
        ...
        RESUL2=START2+(AI2-1.0)*AINC2
!
        IF(I2.EQ.1)GO TO 3919
        IF(START2.LT.STOP2.AND.RESUL2.GT.STOP2)GO TO 3918
        IF(START2.GT.STOP2.AND.RESUL2.LT.STOP2)GO TO 3918
 3919   CONTINUE
        ISET=ISET+1
!
        DO 3920 I1=1,NUMIT1
...
!
          IF(I1.GT.1)THEN
            IF(START1.LT.STOP1.AND.RESUL1.GT.STOP1)GO TO 3928
            IF(START1.GT.STOP1.AND.RESUL1.LT.STOP1)GO TO 3928
          ENDIF
          L2=L2+1
!
          IF(L2.GT.MAXNPP)THEN
...
!
      RETURN
      END SUBROUTINE DP3DP3
      SUBROUTINE DP3DPL(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                        IANGLU,IFORSW,MAXNPP,   &
                        IBUGG2,IBUGG3,IBUGCO,IBUGEV,IBUGQ,ISUBRO,   &
                        IFOUND,IERROR)
!
!     PURPOSE--FORM A VARIETY OF 3-DIMENSIONAL PLOTS--
!                1) A Y VERSUS X1 AND X2 PLOT,
!                2) A MULTI-TRACE (OR MULLTI-SURFACE) PLOT
!                3) A 3-DIMENSIONAL FUNCTION PLOT.
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
!                 NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY
...
!---------------------------------------------------------------------
!
!     ***** THE FOLLOWING 4 DIMENSIONS RAISED FROM 150 TO 225 AUGUST 1983 *****
!     ***** THE FOLLOWING 4 DIMENSIONS RAISED FROM 225 TO 1000 AUGUST 1986 *****
!CCCC DIMENSION ITYPEH(225)
!CCCC DIMENSION IW2HOL(225)
!CCCC DIMENSION IW22HO(225)
!CCCC DIMENSION W2HOLD(225)
...
!
      ...
      MAXCP6=MAXCOL+6
!
!     ***** THE FOLLOWING 6 LINES INSERTED AUGUST 1983 *****
      DO 40 I=1,1000
        ITYPEH(I)='    '
        IW2HOL(I)='    '
        IW22HO(I)='    '
...
!
      ...
      ELSEIF(NUMARG.GE.1.AND.   &
             ICOM.EQ.'3D'.AND.IHARG(1).EQ.'PLOT')THEN
        ILASTC=1
      ELSEIF(NUMARG.GE.2.AND. ICOM.EQ.'3' .AND.   &
             IHARG(1).EQ.'D'.AND.IHARG(2).EQ.'PLOT')THEN
        ILASTC=2
      ELSE
        IFOUND='NO'
        GO TO 9000
...
!               *******************************************
!               **  STEP 3--                             **
!               **  DETERMINE IF HAD OR HAVE THE 'AND'   **
!               **  CONTINUATION CASE.                   **
!               **  IF THE PREVIOUS PLOT COMMAND LINE    **
!               **  HAD AN 'AND' CONTINUATION,           **
!               **  OR IF THE PRESENT PLOT COMMAND LINE  **
!               **  HAS AN 'AND' CONTINUATION,           **
!               **  THEN SET SOME FLAG VARIABLES.        **
!               *******************************************
!
!
      ISTEPN='3'
...
!               ***************************************
!               **  STEP 4--                         **
!               **  DETERMINE THE TYPE OF PLOT CASE  **
...
!
      ...
      DO 811 J=1,NUMARG
        ...
        ELSEIF(IHARG(J).EQ.'VS' .OR. IHARG(J).EQ.'VS.' .OR.   &
           IHARG(J).EQ.'VERS' .AND. IHARG2(J).EQ.'US  ')THEN
          NUMVS=NUMVS+1
          IVSLOC(NUMVS)=J2
        ELSEIF(IHARG(J).EQ.'FOR')THEN
          JP1=J+1
          IF(JP1.GT.NUMARG)GO TO 837
          IF(IHARG(JP1).EQ.'I   '.AND.IHARG2(JP1).EQ.'    ')GO TO 837
          IF(IHARG(JP1).EQ.'ROW '.AND.IHARG2(JP1).EQ.'    ')GO TO 837
          NUMDV=NUMDV+1
  837     CONTINUE
          NUMFO=NUMFO+1
          IFOLOC(NUMFO)=J2
...
!               ******************************************
!               **  STEP 5--                            **
!               **  BRANCH ACCORDING TO THE PLOT CASE.  **
!               ******************************************
!
      IF(IBUGG2.EQ.'ON' .OR. ISUBRO.EQ.'3DPL')THEN
        ISTEPN='5'
...
!
      RETURN
      END SUBROUTINE DP3DPL
      SUBROUTINE DP3DTR(Z,X,Y,N,XEYE0,YEYE0,ZEYE0,XORIG,YORIG,ZORIG,   &
                        I3DTRA,   &
                        XEYE,YEYE,ZEYE,   &
                        ZT,XT,IBUGPL,ISUBRO,IERROR)
!
!     PURPOSE--CARRY OUT THE PERSPECTIVE TRANSFORMATION
!              WHICH CONVERTS POINTS IN 3-SPACE
!              TO POINTS ON THE PERSPECTIVE PLANE.
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
!                 NATIONAL INSTITUTE OF STANDARDS AND TECHNOLOGY
...
!
      ...
      DENOMZ=0.0
!
      IF(IBUGPL.EQ.'OFF'.AND.ISUBRO.NE.'3DTR')GO TO 90
      WRITE(ICOUT,999)
  999 FORMAT(1X)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,51)
...
!               ****************************************
!               **  STEP 12--                         **
!               **  IF (XEYE0,YEYE0,ZEYE0) IS UNDEFINED  **
!               **  (THAT IS, = CPU MINIMUM),         **
!               **  THEN COMPUTE DEFAULT VALUES.      **
!               ****************************************
!
      ISTEPN='12'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!               *******************************************
!               **  STEP 13--                            **
!               **  COMPUTE MIDRANGES FOR THE X, Y,      **
!               **  AND Z VECTORS.                       **
!               **  THIS WILL DEFINE THE 'MIDDLE POINT'  **
!               **  OF THE 3-D PLOT.                     **
!               *******************************************
!
      ISTEPN='13'
...
!               ***************************************************
!               **  STEP 14--                                    **
!               **  COMPUTE THE ENDPONTS OF THE 3-PRONGED AXIS.  **
!               ***************************************************
!
      ISTEPN='14'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!               ***************************************************************
!               **  STEP 15--                                                **
!               **  DETERMINE 3 POINTS WHICH WILL DEFINE EXTREMAL POINTS     **
!               **  ON THE VISUAL PLANE.                                     **
!               **  THIS IS NEEDED SO THAT THE UNDERLYING GRAPHICS SOFTWARE  **
!               **  WILL SHOW A CLOSE POINT CLOAD/FIGURE                     **
!               **  AS BEING LARGE IN APPEARANCE,                            **
!               **  AND A DISTANT POINT CLOUD                                **
!               **  AS BEING SMALL IN APPEARANCE.                            **
!               **  SUCH A STEP IS NECESSARY BECAUSE THE                     **
!               **  UNDERLYING GRAPHICS SOFTWARE WILL BY DEFAULT             **
!               **  GIVE FULL RESOLUTION TO ALL DATA CLOUDS/FIGRUES          **
!               **  WHICH WILL HAVE THE NET EFFECT OF                        **
!               **  ALL DATA CLOUDS/FIGURES BEING LARGE.                     **
!               **  THE 3 CALCULATED EXTREMAL POINTS WILL NEVER              **
!               **  EXPLICITELY APPEAR ON THE PLOT (THEY WILL                **
!               **  HAVE A BLANK PLOT CHARAXCTER AUTOMATICALLY);             **
!               **  THERE EXISTENCE ONLY SERVES TO ASSURE THAT THE           **
!               **  PLOT WINDOW IS APPROPRIATELY STRETCHED.                  **
!               ***************************************************************
!
!               ************************************************************
!               **  STEP 15.1--                                           **
!               **  DEFINE THE PERIPHERAL VISION ANGLE.                   **
!               **  THIS HAS BEEN SET TO 60 DEGREES                       **
!               **  (30   DEGREES ABOVE THE NORMAL LINE                   **
!               **  TO THE VISUAL PLANE AND 30   DEGREES BELOW            **
!               **  THE NORMAL LINE TO THE PLANE).                        **
!               **  COMPUTE THE RADIUS OF THE CIRCLE ON THE VISUAL PLANE  **
!               **  WHICH IS JUST AT THE EDGE OF VISIBILITY--             **
!               **  THE LARGER THE PERIPHERAL ANGLE,                      **
!               **  THE LARGER THE RADIUS, AND VICE VERSA.                **
!               ************************************************************
!
      ISTEPN='15.1'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!
      ...
      IF(IBUGPL.EQ.'OFF'.AND.ISUBRO.NE.'3DTR')GO TO 1519
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,1511)
...
!               ***********************************************************
!               **  STEP 15.2--                                          **
!               **  DETERMINE THE 2 POINTS ON THIS CIRCLE OF VISIBILITY  **
!               **  WHICH INTERSECT WITH THE X = XM PLANE.               **
!               ***********************************************************
!
      ISTEPN='15.2'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!
      ...
      ZD2=ZM
!
!     ***** 7 LINES OF CODE TO ADJUST FOR DIVISION BY 0 ADDED AUGUST 1983 *****
      EPS=0.0000001
      XDEL=XEYE-XM
...
!
      ...
      Z(NP8)=ZD2
!
      IF(IBUGPL.EQ.'OFF'.AND.ISUBRO.NE.'3DTR')GO TO 1529
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
...
!               **  STEP 15.3--                                          **
!               **  DETERMINE THE 2 POINTS ON THIS CIRCLE OF VISIBILITY  **
!               **  WHICH INTERSECT WITH THE Y = YM PLANE.               **
!               ***********************************************************
!
      ISTEPN='15.3'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!
      ...
      ZD2=ZM
!
!     ***** 3 LINES OF CODE TO CHECK FOR DIVISION BY 0 ADDED AUGUST 1983 *****
      DISC=CPUMAX
      IF(XDEL.NE.0.0)DISC=1.0+(ZDEL/XDEL)**2
      DENOM=0.0
      IF(DISC.GT.0.0)DENOM=SQRT(DISC)
      IF(DISC.LT.0.0)GO TO 1530
      ZD1=ZM+RADIUS/DENOM
      ZD2=ZM+RADIUS/(-DENOM)
      XD1=CPUMIN
...
!
      ...
      Z(NP10)=ZD2
!
      IF(IBUGPL.EQ.'OFF'.AND.ISUBRO.NE.'3DTR')GO TO 1539
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
...
!               **  STEP 15.4--                                          **
!               **  DETERMINE THE 2 POINTS ON THIS CIRCLE OF VISIBILITY  **
!               **  WHICH INTERSECT WITH THE Z = ZM PLANE.               **
!               ***********************************************************
!
      ISTEPN='15.4'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!
      ...
      Z(NP12)=ZM
!
      IF(IBUGPL.EQ.'OFF'.AND.ISUBRO.NE.'3DTR')GO TO 1549
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
...
!               **  STEP 20--
!               **  (GENERAL DISCUSSION)                               **
!               **  DETERMINE (IN ORIGINAL COORDINATE SYSTEM VALUES)          **
!               **  WHERE THE DATA POINTS FALL ON THE VISUAL PLANE.           **
!               **  FOR EACH (XD,YD,ZD) DATA POINT,                           **
!               **  DETERMINE WHERE THE VISUAL RAY FROM                       **
!               **  THE DATA POINT TO OUR EYE                                 **
!               **  STRIKES THE VISUAL (PERSPECTIVE) PLANE.                   **
!               **  THE VISUAL PLANE IS THAT PLANE                            **
!               **  WHICH IS NORMAL TO OUR EYE                                **
!               **  AND WHICH CONTAINS THE AVERAGE POINT (XM,YM,ZM).          **
!               **  THE EQUATION OF THE VISUAL PLANE IS                       **
!               **  (XEYE-XM)(X-XM) + (YEYE-YM)(Y-YM) + (ZEYE-ZM)(Z-ZM) = 0
!               **  WHERE X, Y, Z ARE THE DUMMY VARIABLES                     **
!               **  REPRESENTING ANY POINT (X,Y,Z) ON THAT PLANE.             **
!               **  THIS EQUATION MUST BE SOLVED FOR X, Y, AND Z.             **
!               **  THE EQUATIONS OF THE LINE FROM THE DATA POINT (XD,YD,ZD)  **
!               **  TO OUR EYE (XEYE,YEYE,ZEYE) ARE
!               **  (X-XD)/(XEYE-XD) = (Y-YD)/(YEYE-YD) = (Z-ZD)/(ZEYE-ZD)
!               **  WHERE (XD,YD,ZD) REPRESENTS A DATA POINT.                 **
!               **  THE VISUAL PLANE EQUATION AND THE LINE EQUATIONS          **
!               **  MUST BE COMBINED TO SOLVE FOR THE VALUES (X,Y,Z)          **
!               **  ON THE VISUAL PLANE AS OUR EYE SEES THEM.                 **
!               ****************************************************************
!
!               ****************************************************************
!               **  STEP 21--
!               **  THE FINAL PLOT STATEMENT WILL INVOLVE
!               **  ONLY 2 VECTORS.
!               **  AT THE MOMENT, THE POINTS (XP,YP,ZP)
!               **  ON THE VISUAL PLANE ARE DEFINED
!               **  BY 3 COORDINATE VALUES.
!               **  TO REDUCE THE 3 COORDINATE VALUES
!               **  TO 2 COORDINATE VALUES,
!               **  WE MUST ROTATE THE VISUAL PLANE
!               **  SO THAT IT IS PARALLEL TO THE ORIGINAL XZ PLANE.
!               **  TO CARRY OUT SUCH A ROTATION, WE MUST
!               **  DETERMINE THE DIRECTION NUMBERS AND DIRECTION COSINES
!               **  OF THE NEW AXES IN TERMS OF THE OLD COORDINATE SYSTEM.
!               **  THE NEW Y AXIS WILL (BY CONSTRUCTION) BE
!               **  ON THE NORMAL LINE TRAVELING FROM
!               **  THE AVERAGE POINT (XM,YM,ZM) TO OUR EYE POINT (XEYE,YEYE,ZEY
!               **  AND WILL THEREFORE HAVE DIRECTIONS NUMBERS XEYE, YEYE, AND Z
!               **  THE NEW Z AXIS WILL BE PERPENDICULAR TO THE NEW Y AXIS
!               **  AND WILL RESIDE IN THE PLANE CONTAINING THE
!               **  THE FOLLOWING 3 POINTS--
!               **      1) THE AVERAGE POINT (XM,YM,ZM)
!               **      2) THE EYE POINT (XEYE,YEYE,ZEYE)
!               **      3) SOME POINT (SAY (XM,YM,ZM+1)) OF THE OLD Z AXIS
!               **         DISPLACED OVER SO AS TO EMANATE FROM (XM,YM,ZM).
!               **  THE ABOVE 3 POINTS DEFINE A VERTICAL PLANE.
!               **  THE PURPOSE OF THE VERTICAL PLANE IS TO DEFINE
!               **  WHICH DIRECTION IS 'UP' IN THE FINAL PICTURE.
!               **  THE EQUATION OF THE VERTICAL PLANE IS
!               **  (A-XM)(X-XM) + (B-YM)(Y-YM) + (C-ZM)(Z-ZM) = 0 .
!               **  THIS EQUATION MUST BE SOLVED FOR A, B, AND C.
!               **  WITHOUT LOSS OF GENERALITY, A MAY BE INITIALLY SET TO 1.
!               **  THE SOLUTION TURNS OUT TO BE
!               **      A = 1
!               **      B = -XEYE/YEYE
!               **      C = 0
!               **  NOTE, HOWEVER, THAT THESE A, B, AND C VALUES
!               **  FOR THIS VERTICAL PLANE WILL BE IDENTICAL TO THE
!               **  DIRECTION NUMBERS FOR THE NORMAL TO THIS VERTICAL PLANE
!               **  WHICH IS IDENTICALLY THE NEW X AXIS
!               **  AND SO THE ABOVE A, B, AND C VALUES DEFINE THE DIRECTION
!               **  DIRECTION NUMBERS FOR THE NEW X AXIS.
!               **  TO SOLVE FOR THE DIRECTION NUMBERS FOR THE NEW Z AXIS,
!               **  WE SEEK 3 DIRECTION NUMBERS D, E, AND F
!               **  WHICH MUST BE PERPENDICULAR TO BOTH THE
!               **  NEW Y AXIS (WITH DIRECTION NUMBERS XEYE, YEYE, AND ZEYE)
!               **  AND THE NEW X AXIS (WITH DIRECTION NUMBERS A, B, AND C ABOVE
!               **  WITHOUT LOSS OF GENERALITY, D MAY BE INITIALLY SET TO 1.
!               **  NOTE THAT WHENEVER 2 LINES ARE PERPENDICULAR,
!               **  THE INNER PRODUCT OF THE DIRECTION NUMBERS MUST = 0.
!               **  WITHOUT LOSS OF GENERALITY, D MAY BE INITIALLY SET TO 1.
!               **  INCORPORATING THE 2 INNER PRODUCT EQUATIONS,
!               **  WE MAY SOLVE FOR E AND F.
!               **  THE SOLUTIONS TURN OUT TO BE
!               **      D = 1
!               **      E = YEYE/XEYE
!               **      F = (-XEYE*XEYE - YEYE*YEYE) / (XEYE*ZEYE)
!               **
!               **  IN SUMMARY, THE DIRECTION NUMBERS FOR THE 3 NEW AXES
!               **  MAY BE WRITTEN AS
!               **      NEW X AXIS:  YEYE       -XEYE     0
!               **      NEW Y AXIS:  XEYE       YEYE      ZEYE
!               **      NEW Z AXIS:  -XEYE*ZEYE   -YEYE*ZEYE  XEYE*XEYE+YEYE*YEY
!               **  NOTE THAT BY INSPECTION WE SEE RETROSPECTIVELY
!               **  THAT THE 3 INNER PRODUCTS ALL = 0
!               **  AND SO THE 3 DEFINED AXES ARE ALL PERPENDICULAR
!               **  (AS THEY SHOULD BE).
!               **
!               **  THE CORRESPONDING DIRECTION COSINES
!               **  ARE GOTTEN BY NORMALIZATION TO UNITY;
!               **  LET US SYMBOLICALLY REPRESENT THEM BY--
!               **      DCXX   DCXY   DCXZ
!               **      DCYX   DCYY   DCYZ
!               **      DCZX   DCZY   DCZZ
!               **  THE ABOVE RESULTS WERE ACTUALLY ARRIVED AT
!               **  (AND ARE VALID FOR) BY DISPLACING THE OLD ORIGIN
!               **  FROM (0,0,0) TO (XM,YM,ZM).
!               **  THIS SIMPLIFIES THE EQUATIONS CONSIDERABLY.
!               **
!               **  GIVEN THAT WE NOW HAVE THE DIRECTION COSINES
!               **  OF THE NEW AXES IN TERMS OF THE OLD COORDINATES,
!               **  WE MAKE USE OF
!               **  EISENHART (COORDINATE GEOMETRY, PAGE 160) WHICH STATES
!               **  THAT THE LINEAR TRANSFORMATION THAT IS NEEDED TO CARRY OUT
!               **  THE ROTATION FROM THE VISUAL PLANE TO THE XZ PLANE
!               **  IS GIVEN BY
!               **      XT = XM + DCXX(X-XM) + DCXY(Y-YM) + DCXZ(Z-ZM)
!               **      YT = YM + DCYX(X-XM) + DCYY(Y-YM) + DCYZ(Z-ZM)
!               **      ZT = ZM + DCZX(X-XM) + DCZY(Y-YM) + DCZZ(Z-ZM)
!               **
!               **  NOTE THAT BY INSPECTION OF THE ABOVE TRANSFORMATION
!               **  IT IS SEEN THAT (XM,YM,ZM) IS MAPPED INTO (XM,YM,ZM)
!               **  (AS IT SHOULD BE).
!               **  NOTE ALSO THAT THE EYE POINT AND ANY POINT ALONG THE LINE
!               **  OF SIGHT WOULD HAVE BEEN MAPPED INTO (XM,YM,ZM)
!               **  AS IT SHOULD BE.
!               **  NOTE ALSO THAT ALL POINTS ON THE VISUAL PLANE
!               **  SINCE THEY SATISFY
!               **     (XEYE-XM)(X-XM) + (YEYE-YM)(Y-YM) + (ZEYE-ZM)(Z-ZM) = 0
!               **  GETS MAPPED INTO THE CONSTANT YT VALUE OF YT = YM
!               **  AND SO THE TRANSFORMED PLOT SURFACE IS ONE WHICH
!               **  IS PARALLEL TO THE XZ PLANE BUT IS DISPLACED
!               **  YM UNITS OUT FROM THE XZ PLANE.
!               **  THIS PLOT PLANE WILL CONTAIN THE POINT (XM,YM,ZM).
!               ****************************************************************
!
      ISTEPN='21'
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
...
!
!     ***** 15 LINES OF CODE TO CHECK FOR DIVISION BY 0 ADDED AUGUST 1983 *****
      DCXX=CPUMAX
      DCXY=CPUMAX
      DCXZ=CPUMAX
      IF(DENOMX.EQ.0.0)GO TO 2121
      DCXX=DNXX/DENOMX
      DCXY=DNXY/DENOMX
      DCXZ=DNXZ/DENOMX
 2121 CONTINUE
...
!
      ...
      CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
      IF(I3DTRA.EQ.'ORTH')GO TO 2300
      GO TO 2400
!
!               **************************************************
!               **  STEP 23--                                   **
!               **  TREAT THE ORTHOGRAPHIC TRANSFORMATION CASE  **
!               **************************************************
!
 2300 CONTINUE
!
      ...
      CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
!     THE FOLLOWING IS INCORRECT (XM FOR X(I) ETC.)
      DO 2310 I=1,NP12
!
!     ***** 5 LINES OF CODE TO ADJUST FOR DIVISION BY 0 ADDED AUGUST 1983 *****
      EPS=0.0000001
      A11=XDEL
      A12=YDEL
      A13=ZDEL
...
!
      ...
      XPI=(R2-A23*YPI)/A21
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
      WRITE(ICOUT,2311)I,XPI,YPI,ZPI
...
!CCCC YT(I)=YM+DCYX*DELX+DCYY*DELY+DCYZ*DELZ
...
!               **************************************************
!               **  STEP 22--                                   **
!               **  TREAT THE PERSPECTIVE TRANSFORMATION CASE   **
!               **************************************************
!
 2400 CONTINUE
!
...
!
      ...
      XPI=(R2-A22*YPI)/A21
      IF(IBUGPL.EQ.'ON'.OR.ISUBRO.EQ.'3DTR')   &
      WRITE(ICOUT,2411)I,XPI,YPI,ZPI
...
!               *****************
!
      IF(IBUGPL.EQ.'OFF'.AND.ISUBRO.NE.'3DTR')GO TO 9090
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,9011)
...
!
      RETURN
      END SUBROUTINE DP3DTR
      SUBROUTINE DP3MSM(X,N,XS,ICHANG,IBUGG3,IERROR)
!
!     PURPOSE--THIS SUBROUTINE TAKES THE DATA IN THE VECTOR X,
!              APPLIES A 3-TERM MEDIAN SMOOTH, AND PUTS THE
!              RESULTS IN A VECTOR XS.
!     NOTE--THE VECTOR X REMAINS UNCHANGED.
!     OUTPUT ARGUMENTS--XS     = THE SINGLE PRECISION VECTOR
!                                CONTAINING SMOOTHED VALUES.
!                     --ICHANG = THE CHARACTER VARIABLE
!                                CONTAINING EITHER YES OR NO
!                                DEPENDING ON WHETHER OR NOT THE
!                                SMOOTHED DATA IS CHANGED OR NOT
!                                FROM THE ORIGINAL DATA.
!     OUTPUT--THE COMPUTED SINGLE PRECISION VECTOR
!             OF SMOOTHED VALUES.
!     ASSUMPTION--THE VECTOR X HAS AT LEAST 3 VALUES.
!     LANGUAGE--ANSI FORTRAN (1977)
!     REFERENCES--MCNEIL, INTERACTIVE DATA ANALYSIS
!                 1977, PAGE 144
!                 (= SOURCE OF ALGORITHM).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
...
!
      RETURN
      END SUBROUTINE DP3MSM
      SUBROUTINE DP3RSM(X,XJUNK,N,XS,ICHANG,IBUGG3,IERROR)
!
!     PURPOSE--THIS SUBROUTINE TAKES THE DATA IN THE VECTOR X,
!              AND REPEATEDLY APPLIES A 3-TERM MEDIAN SMOOTH
!              UNTIL NO CHANGE OCCURS AFTER THE SMOOTHING OPERATION.
!     OUTPUT ARGUMENTS--XS     = THE SINGLE PRECISION VECTOR
!                                CONTAINING SMOOTHED VALUES.
!                     --ICHANG = THE CHARACTER VARIABLE
!                                CONTAINING EITHER YES OR NO
...
!               ************************************************
!               **  STEP 1--                                  **
!               **  SMOOTH THE RAW DATA WITH 3-TERM MEDIANS.  **
!               **  IF NO CHANGE, THEN EXIT.                  **
!               ************************************************
!
      CALL DP3MSM(X,N,XS,ICHANG,IBUGG3,IERROR)
      IF(ICHANG.EQ.'NO')GO TO 9000
!
!               *********************************************
!               **  STEP 2--                               **
!               **  SINCE THERE WAS A CHANGE, THEN         **
!               **  REPEATEDLY SMOOTH THE SMOOTHED VALUES  **
!               **  UNTIL NO CHANGE.                       **
!               *********************************************
!
      NUMIT=0
 ...
 1100 CONTINUE
      ...
      XS(I)=XJUNK(I)
 1200 CONTINUE
      IF(NUMIT.GT.MAXIT)GO TO 1250
      IF(ICHANG.EQ.'YES')GO TO 1100
      GO TO 1290
 1250 CONTINUE
!     WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
...
!               ********************************************************
!               **  STEP 3--                                          **
!               **  MAKE A FINAL CHECK TO SEE IF THE SMOOTHED VALUES  **
!               **  HAVE CHANGED ANY FROM THE RAW DATA.               **
!               ********************************************************
!
      ICHANG='NO'
      DO 1300 I=1,N
      IF(XS(I).NE.X(I))GO TO 1310
 1300 CONTINUE
      GO TO 1390
 1310 CONTINUE
      ICHANG='YES'
...
!
      RETURN
      END SUBROUTINE DP3RSM
      SUBROUTINE DP3RSR(X,XJUNK,N,PRED2,RES2,IBUGG3,IERROR)
!
!     PURPOSE--THIS SUBROUTINE TAKES THE DATA IN THE VECTOR X,
!              AND APPLIES A 3RSR SMOOTHING, THAT IS,
!              MEDIANS OF 3 (REPEATED UNTIL NO CHANGE) FOLLOWED BY
!              SPLITTING (REPEATED UNTIL NO CHANGE).
!     OUTPUT ARGUMENTS--PRED2  = THE SINGLE PRECISION VECTOR
!                                CONTAINING SMOOTHED VALUES.
!                       RES2   = THE SINGLE PRECISION VECTOR
!                                CONTAINING RESIDUALS FROM THE SMOOTH.
!     OUTPUT--THE COMPUTED SINGLE PRECISION VECTOR
!             OF SMOOTHED VALUES.
!     NOTE--THE VECTOR X REMAINS UNCHANGED.
!     LANGUAGE--ANSI FORTRAN (1977)
!     REFERENCES--MCNEIL, INTERACTIVE DATA ANALYSIS
!                 1977, PAGE 146 AND 124
!                 (= SOURCE OF ALGORITHM).
!     WRITTEN BY--JAMES J. FILLIBEN
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
...
!               ********************************************
!               **  STEP 1--                              **
!               **  CARRY OUT A 3R SMOOTHING, THAT IS,    **
!               **  APPLY 3-TERM MEDIANS AND REPEAT THIS  **
!               **  UNTIL NO CHANGE                       **
!               ********************************************
!
...
!               **  STEP 2--                                               **
!               **  SET UP A LOOP.                                         **
!               **  INSIDE THE LOOP, CARRY OUT                             **
!               **     1) A SPLIT & SMOOTH                                 **
!               **     2) A 3-TERM MEDIAN SMOOTH REPEATED UNTIL NO CHANGE  **
!               **  REPEAT THE LOOP UNTIL NO CHANGE                        **
!               *************************************************************
!
 1000 CONTINUE
!
...
!               ****************************************************************
!               **  STEP 2.2--                                                 *
!               **  CARRY OUT A 3R SMOOTHING ON THE SMOOTHED VALUES, THAT IS,  *
!               **  APPLY 3-TERM MEDIANS AND REPEAT UNTIL NO CHANGE            *
!               ****************************************************************
!
...
!               *******************************************************
!               **  STEP 2.3--                                       **
!               **  COPY RESIDUALS INTO RES2(.).                     **
!               **  IF CHANGES HAD OCCURRED IN LAST 3R SMOOTH,       **
!               **  THEN REPEAT ENTIRE SPLIT/SMOOTH AND 3R PROCESS.  **
!               *******************************************************
!
      DO 1100 I=1,N
      RES2(I)=X(I)-PRED2(I)
...
!
      ...
      SUBROUTINE DP4PLO(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                        ...
                        IFOUND,IERROR)
!
!     PURPOSE--GENERATE THE FOLLOWING 4 PLOTS
!              (ALL ON THE SAME PAGE)--
!                 1) A RUN SEQUENCE PLOT;
!                 2) A LAG PLOT;
!                 3) A HISTOGRAM;
...
!     LANGUAGE--ANSI FORTRAN (1977)
!     VERSION NUMBER--89/2
!     ORIGINAL VERSION (AS A SEPARATE SUBROUTINE)--JANUARY   1989.
!     UPDATED         --APRIL     1989. BY ALAN
!     UPDATED         --NOVEMBER  1989. CHAR*4 FOR IBUGU.. (NELSON)
!     UPDATED         --NOVEMBER  1989. DIM. FOR CLLIMI & CLWIDT
!     UPDATED         --NOVEMBER  1989. ALLOW 4PLOT SYNONYM
!     UPDATED         --AUGUST    1992. ARGUMENT LIST TO DPGRAP
!     UPDATED         --DECEMBER  1993. ARGUMENT LIST TO DPPP
!     UPDATED         --DECEMBER  1993. BUG WITH X3LAB
!     UPDATED         --MARCH     1996. IRHSTG
!     UPDATED         --AUGUST    1999. ARGUMENT LIST TO DPGRAP
!     UPDATED         --MARCH     2002. SIZE BASED ON MULTIPLOT
!                                       CORNER COORDINATES
!     UPDATED         --OCTOBER   2006. I4PLDI (GENERATE EXPO
!                                       PROB PLOT INSTEAD OF
!                                       NORMAL PROB PLOT)
!     UPDATED         --JANUARY   2010. CALL LIST TO DPHIST
!     UPDATED         --JUNE      2011. SUPPORT FOR "HIGHLIGHT" OPTION
!     UPDATED         --FEBRUARY  2012. FOR LAG PLOT, ADD CHECK FOR
!                                       EMPTY CHARACTER SETTING
!
!-----CHARACTER STATEMENTS FOR NON-COMMON VARIABLES-------------------
!
      CHARACTER*4 ICAPSW
...
!
      ...
      IVLOC=0
!CCCC IVLOC=7
!CCCC IF(IANS(7).EQ.'    ')IVLOC=8
      DO 21 I=1,50
        IF(IANS(I).EQ.'P' .AND. IANS(I+1).EQ.'L' .AND.   &
           IANS(I+2).EQ.'O' .AND. IANS(I+3).EQ.'T')THEN
          IVLOC=I+5
          GO TO 29
        ENDIF
 21   CONTINUE
 29   CONTINUE
      ...
      NCLP=9
      NCHI=10
!CCCC THE FOLLOWING CORRECTION WAS MADE JANUARY 1989
      NCNP=24
      NCEP=29
!CCCC NCNP=25
!
!               ******************************************
!               **  TREAT THE 4-PLOT ... ANALYSIS CASE  **
!               ******************************************
!
  ...
  999   FORMAT(1X)
   ...
   61     CONTINUE
      ...
      ENDIF
!
!CCCC THE FOLLOWING SECTION WAS INSERTED NOVEMBER 1989
!               **************************************************
!               **  STEP 10--                                   **
!               **  EXTRACT THE COMMAND                         **
!               **************************************************
...
!               **************************************************
!               **   STEP 21--                                  **
!               **   GENERATE THE RUN SEQUENCE PLOT             **
!               **************************************************
!
      ISTEPN='21'
      IF(IBUGG3.EQ.'ON'.OR.ISUBRO.EQ.'4PLO')   &
      CALL TRACE2(ISTEPN,ISUBN1,ISUBN2)
!
!CCCC MARCH 2002.  USE MULTIPLOT CORNER COORDINATES
!CCCC PWXMIN=0.0
!CCCC PWXMAX=50.0
!CCCC PWYMIN=50.0
!CCCC PWYMAX=100.0
      ...
      IF(IHIGH.EQ.'OFF')THEN
        ...
        CALL DPPLOT(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                    ...
                    IFOUND,IERROR)
!CCCC   THE FOLLOWING CORRECTION WAS MADE JANUARY 1989
!CCCC   IF(IERROR.EQ.'YES')GO TO 9000       JANUARY 1989
...
!CCCC PWYMAX=50.0
!
!CCCC OCTOBER 2006.  OPTIONALLY GENERATE EXPONENTIAL
!CCCC                PROBABILITY PLOT (E.G., WHEN CHECKING
!CCCC                FOR HOMOGENEOUS POISSON PROCESS).
!
      PWXMIN=PMXMIN + (PMXMAX-PMXMIN)/2.0
      PWXMAX=PMXMAX
      PWYMIN=PMYMIN
...
!
 ...
 2507   FORMAT('IMANUF,NUMDEV,IDMANU(1) = ',A4,I8,2X,A4)
      ...
      ENDIF
!
!CCCC ADD FOLLOWING TO DPGRAP ARGUMENT LIST
      IMPARG=2
      ...
      IBUGUG,IBUGU2,IBUGU3,IBUGU4,ISUBRO,   &
      IERROR)
!CCCC IF(IFOUND.EQ.'YES'.AND.IAND2.EQ.'NO')IAUTEX='OFF'
      IF(IERROR.EQ.'NO')IAND1=IAND2
      IF(IERROR.EQ.'YES')GO TO 9000
      NDONE=NDONE+1
      IF(NDONE.LE.1)GO TO 2200
      IF(NDONE.EQ.2)GO TO 2300
      IF(NDONE.EQ.3)GO TO 2400
      IF(NDONE.GE.4)GO TO 2800
      GO TO 9000
!
!               **************************************************
!               **   STEP 28--                                  **
...
!
      ...
      ELSE
        ...
        IHARG(2)='PLOT'
      ENDIF
!CCCC THE FOLLOWING 1-LINE INSERTION WAS MADE JANUARY 1989
      IF(IERROR.EQ.'YES')GO TO 9000
      GO TO 9000
!
!               *****************
...
!
      ...
      SUBROUTINE DP6PLO(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
                        ...
                        IFOUND,IERROR)
!
!     PURPOSE--GENERATE THE FOLLOWING 6 (POST-FIT VALIDATION)
!              PLOTS (ALL ON THE SAME PAGE)--
!                 1) Y & PREDICTED VERSUS X
!                 2) RESIDUALS VERSUS X
!                 3) RESIDUALS VERSUS PREDICTED
...
!     ORIGINAL VERSION (AS A SEPARATE SUBROUTINE)--DECEMBER  1993.
!     UPDATED       --MARCH      1996. IRHSTG TO DPHIST
!     UPDATED       --AUGUST     1999. DPGRAP ARGUMENT LIST
!     UPDATED       --MARCH      2002. SUPPORT FOR MULTIPLOT CORNER
!                                      COORDINATES (I6PLMC SWITCH)
!     UPDATED       --JANUARY    2010. CALL LIST TO DPHIST
!
!-----CHARACTER STATEMENTS FOR NON-COMMON VARIABLES-------------------
!
...
!CCCC MARCH 1996.  ADD FOLLOWING LINE
      ...
      CHARACTER*4 IHSTOU
      CHARACTER*4 IHSTOP
!CCCC MARCH 2002.  ADD FOLLOWING LINE
      CHARACTER*4 I6PLMC
!
      CHARACTER*4 ISTEPN
      CHARACTER*4 ISUBN1
...
!
!               *************************************************
!               **  TREAT THE     6-PLOT Y X    ANALYSIS CASE  **
!               *************************************************
!
      IF(IBUGG2.EQ.'OFF'.AND.ISUBRO.NE.'6PLO')GO TO 90
      WRITE(ICOUT,999)
  999 FORMAT(1X)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,51)
      ...
      IF(IMAX.GE.1)THEN
         DO 1200 I=1,IMAX
            ...
            IF(IANSLC(I).EQ.'S'.AND.IANSLC(IP1).EQ.'U'.AND.   &
               IANSLC(IP2).EQ.'B'.AND.IANSLC(IP3).EQ.'S'.AND.   &
               IANSLC(IP4).EQ.'E'.AND.IANSLC(IP5).EQ.'T'.AND.   &
               IANSLC(IP6).EQ.' ')GO TO 1290
            IF(IANSLC(I).EQ.'E'.AND.IANSLC(IP1).EQ.'X'.AND.   &
               IANSLC(IP2).EQ.'C'.AND.IANSLC(IP3).EQ.'E'.AND.   &
               IANSLC(IP4).EQ.'P'.AND.IANSLC(IP5).EQ.'T'.AND.   &
               IANSLC(IP6).EQ.' ')GO TO 1290
            IF(IANSLC(I).EQ.'F'.AND.IANSLC(IP1).EQ.'O'.AND.   &
                IANSLC(IP2).EQ.'R'.AND.IANSLC(IP3).EQ.' ')GO TO 1290
            IF(IANSLC(I).EQ.'s'.AND.IANSLC(IP1).EQ.'u'.AND.   &
               IANSLC(IP2).EQ.'b'.AND.IANSLC(IP3).EQ.'s'.AND.   &
               IANSLC(IP4).EQ.'e'.AND.IANSLC(IP5).EQ.'t'.AND.   &
               IANSLC(IP6).EQ.' ')GO TO 1290
...
!
      IFLAG=1
!
!CCCC MARCH 2002.  SUPPORT FOR MULUTPLOT CORNER COORDINATES
!CCCC PWXMIN=10.0
!CCCC PWXMAX=36.666667
!CCCC PWYMIN=50.0
!CCCC PWYMAX=90.0
      PWXMIN=PMXMIN
...
!
      ...
      CALL DPPLOT(NPLOTV,NPLOTP,NS,ICASPL,IAND1,IAND2,   &
      IANGLU,MAXNPP,   &
      IBUGG2,IBUGG3,IBUGCO,IBUGEV,IBUGQ,ISUBRO,IFOUND,IERROR)
...
!
!CCCC MARCH 2002.  SUPPORT FOR MULUTPLOT CORNER COORDINATES
!CCCC PWXMIN=36.666667
!CCCC PWXMAX=63.333333
!CCCC PWYMIN=50.0
!CCCC PWYMAX=90.0
...
!               **************************************************
!               **   STEP 26--                                  **
!               **   GENERATE     NORMAL PROBABILITY PLOT RES   **
!               **************************************************
!
 2600 CONTINUE
      ISTEPN='26'
...
!
      IFLAG=6
!
!CCCC MARCH 2002.  SUPPORT FOR MULTIPLOT CORNER COORDINATES
!CCCC PWXMIN=63.333333
!CCCC PWXMAX=90.0
!CCCC PWYMIN=10.0
!CCCC PWYMAX=50.0
...
!
!CCCC ISHIFT=0
!CCCC CALL SHIFTL(ISHIFT,IHARG,IHARG2,IARG,ARG,IARGT,NUMARG,
!CCCC1IBUGG3,IERROR)
      ICOM='NORM'
      ICOM2='    '
      IHARG(1)='PROB'
...
!               **************************************************
!               **   STEP 60--                                  **
!               **   PLOT THE CURRENT PLOT (OUT OF THE 6)       **
!               **************************************************
 6000 CONTINUE
      ISTEPN='60'
      IF(IBUGG2.EQ.'ON'.OR.ISUBRO.EQ.'6PLO')   &
...
!
      ...
      IF(NDONE.EQ.2)GO TO 2300
      IF(NDONE.EQ.3)GO TO 2400
      IF(NDONE.EQ.4)GO TO 2500
      IF(NDONE.EQ.5)GO TO 2600
      IF(NDONE.GE.6)GO TO 8000
!
!               **************************************************
!               **   STEP 80--                                  **
!               **   REINSTATE INITIAL SETTINGS                 **
...
!
 9000 CONTINUE
      IF(IBUGG2.EQ.'OFF'.AND.ISUBRO.NE.'6PLO')GO TO 9090
      WRITE(ICOUT,999)
      CALL DPWRST('XXX','BUG ')
      WRITE(ICOUT,9011)
