...
!                15) CONFIDENCE LIMITS FOR KENDALL TAU CORRELATION
!                    COEFFICIENT
!                16) CONFIDENCE LIMITS FOR PASSING-BABLOK REGRESSION
!                17) CONFIDENCE LIMITS FOR THEIL-SEN REGRESSION
!
!     WRITTEN BY--ALAN HECKERT
!                 STATISTICAL ENGINEERING DIVISION
!                 INFORMATION TECHNOLOGY LABORATORY
...
!                                       REGRESSION
!     UPDATED         --MAY       2026. KENDALL TAU CORRELATION
!     UPDATED         --MAY       2026. PASSING-BABLOK REGRESSION
!     UPDATED         --MAY       2026. THEIL-SEN REGRESSION
!
!-----CHARACTER STATEMENTS FOR NON-COMMON VARIABLES-------------------
!
      CHARACTER*4 ICASAN
...
!
      ...
      IF(ICASAN.EQ.'PBIN')NUMROW=3
      IF(ICASAN.EQ.'PBSL')NUMROW=3
      IF(ICASAN.EQ.'PBI2')NUMROW=3
      IF(ICASAN.EQ.'PBS2')NUMROW=3
      IF(ICASAN.EQ.'TSIN')NUMROW=3
      IF(ICASAN.EQ.'TSSL')NUMROW=3
      IF(ICASAN.EQ.'TSI2')NUMROW=3
      IF(ICASAN.EQ.'TSS2')NUMROW=3
      NUMCOL=5
!
      IF(ICASAN.EQ.'QUC2')THEN
        ...
        NCTIT9=47
        NUMCOL=3
      ELSEIF(ICASAN.EQ.'CORR' .OR. ICASAN.EQ.'KTAU')THEN
        NUMCOL=4
        NUMROW=7
        IF(ICASAN.EQ.'KTAU')NUMROW=5
      ...
      ELSEIF(ICASAN.EQ.'LPS3')THEN
        NUMCOL=3
      ELSEIF(ICASAN.EQ.'PBIN' .OR. ICASAN.EQ.'PBSL')THEN
        NUMCOL=3
      ELSEIF(ICASAN.EQ.'PBI2' .OR. ICASAN.EQ.'PBS2')THEN
        NUMCOL=3
      ELSEIF(ICASAN.EQ.'TSIN' .OR. ICASAN.EQ.'TSSL')THEN
        NUMCOL=3
      ELSEIF(ICASAN.EQ.'TSI2' .OR. ICASAN.EQ.'TSS2')THEN
        NUMCOL=3
      ENDIF
...
!
 ...
 4225   CONTINUE
        JCNT=1
        AMAT(I,JCNT)=CONF(I)
        IF(ICASAN.EQ.'CORR' .OR. ICASAN.EQ.'PERM' .OR.                 &
           ICASAN.EQ.'SRC2' .OR. ICASAN.EQ.'KTAU')THEN
          JCNT=JCNT+1
          AMAT(I,JCNT)=T(I)
        ELSEIF(ICASAN.EQ.'MRC2')THEN
          JCNT=JCNT+1
